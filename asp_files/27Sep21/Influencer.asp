                                                        ...
                                                        <thead>
                                                            <tr class="m-0 p-0 border-0">
                                                                <td class="d-flex flex-wrap " style="background-color:#ffffff">
																	<p class="px-2">
                                                                    <%=RSInfpeople("firstname")%>&nbsp;
                                                                        <%=RSInfpeople("lastname")%> is a leading market influencer. Profile and expertise is developed using a tiered AI curation followed by in-house team review and validated peer or known-party inputs.</p>
                                                                </td>
                                                            </tr>
                                                        </thead>
                                                    </table>
                                                                        ...
                                                                        <div class="w-100 d-flex justify-content-between">
                                                                            <div class="w-100 d-flex justify-content-between">
                                                                                <div class="input_block d-flex">
                                                                                    <input type="checkbox" data-toggle="collapse" <%=chkval%> data-target="#collapse_<%=trim(RSInfProjects("code"))%>" aria-expanded="true" aria-controls="collapseOne" class="mr-2">
								 ...
								 <input type="submit" id="submit_form" name="send_mail" value="SUBMIT FORM" class="button1 mx-auto rounded-0 shadow  d-block submit_button" style="float: none;">-->
                                            ...
                                            <div id="view_profile" aria-expanded="false" data-parent="#COLLAPSE_BLOCK" class="collapse w-100" style="">
                                                <div class="w-xl-60 w-lg-60 w-md-100 w-sm-100 mx-auto mt-4">
                                                    ...
                                                    <div class="w-100 text-center border-top py-2">
                                                        <h4 class="font-weight-bold  my-2" style="font-size: 20px!important;">REGISTER TO PROFILE</h4>
                                                    </div>
