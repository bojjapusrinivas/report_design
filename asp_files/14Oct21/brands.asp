                        ...
                        <div class="w-100 d-flex justify-content-between">
                           <div class="d-flex justify-content-start">
                              ...
                              <h4 class="font-weight-bold mb-0"><a
                                 href="<%=trim(RSInfProjects("file_name"))%>"target="new" class="text-dark pl-2"><%=trim(RSInfProjects("title"))%></a> 
                              </h4>
                           </div>
                     ...
                     <div id="collapse_<%=trim(RSInfProjects("code"))%>" aria-expanded="false" class="collapse">
                           <div class="w-100">
							 ...
							 <div class="w-100 border-top  py-2" id="block_01">
								<div class='d-flex mr-3 w-100 pl-1 mb-3'><i style="line-height: normal"><strong> to viewbrand images. Help curate image and data to receive complimentary cluster data.</strong></i></div>
                                 <!---Mobile Games-->
