	...
	<td valign="top">
			...
			<table align="center" width="100%" border="1" bordercolor="black" cellpadding="2" cellspacing="2" bgcolor="#f0e5dd" style="border-collapse:collapse;">
				...
				if trim(request("btnsubmit"))="Search" then
					...
					if myval=1 then
						usql1="OPEN SYMMETRIC KEY SKEY_GI1_DB_1 DECRYPTION BY CERTIFICATE CERT_GI1_DB_1; select CONVERT(varchar(500), DecryptByKey(EmailID)) as EmailID1,userid,User_Surname,firstname,LastName,User_Company,Address1,Address2,City,State,Country,Zip,Telephone,Fax,User_Business,JobFunction,User_website,user_position,Sort_User_by_Type,secret_Answer,Channel_Partner,Date_created,User_IP,user_Status,company_cp_code  from User_Master where "&AddSQlSTR&" and "&mystring&" order by userid desc"
					else
						usql1="OPEN SYMMETRIC KEY SKEY_GI1_DB_1 DECRYPTION BY CERTIFICATE CERT_GI1_DB_1; select CONVERT(varchar(500), DecryptByKey(EmailID)) as EmailID1,userid,User_Surname,firstname,LastName,User_Company,Address1,Address2,City,State,Country,Zip,Telephone,Fax,User_Business,JobFunction,User_website,user_position,Sort_User_by_Type,secret_Answer,Channel_Partner,Date_created,User_IP,user_Status,company_cp_code  from User_Master where "&AddSQlSTR&" order by userid desc"
					end if
				else	
					usql1="OPEN SYMMETRIC KEY SKEY_GI1_DB_1 DECRYPTION BY CERTIFICATE CERT_GI1_DB_1; select CONVERT(varchar(500), DecryptByKey(EmailID)) as EmailID1,userid,User_Surname,firstname,LastName,User_Company,Address1,Address2,City,State,Country,Zip,Telephone,Fax,User_Business,JobFunction,User_website,user_position,Sort_User_by_Type,secret_Answer,Channel_Partner,Date_created,User_IP,user_Status,company_cp_code from User_Master where "&AddSQlSTR&" order by userid desc"
				end if
				''response.write usql1
				rsDisp.Open usql1 ',DataSource1,3,1
				''paging
				'rsDisp.movefirst
				rowcount = 0
				Start = 1
				...
				Response.Write ("<tr>")
					...
					Response.Write ("<th><font face=""verdana"" size=""2"">Rated</font></th>")
				...
				IF not rsDisp.EOF THEN
					...
					while not rsDisp.EOF and rowcount<rsDisp.PageSize
						...
						Response.Write ("<tr bgcolor='white'>")
							...
							Response.Write ("<td align='center'><font face='verdana' size='2'>"& rsDisp("Sort_User_by_Type") &"</font></td>")
							...
							if trim(ucase(transStatus))="A" then
								...
								Response.Write ("<td align='center'><!--a href='ViewAllUsers.asp?ValEdit=3&RecID="&rsDisp("userid")&"&emailid="&rsDisp("emailid1")&"'><font face='verdana' size='2'>Code 3</font></a> | --> <a href='ViewAllUsers.asp?ValStat=B&RecID="&rsDisp("userid")&"&emailid="&rsDisp("emailid1")&"'><font face='verdana' size='2'>Block</font></a> | <a href='ViewAllUsers.asp?ValEditset=yes&RecID="&rsDisp("userid")&"'><font face='verdana' size='2'>Edit</font></a></td>")
							else
								...
								Response.Write ("<td align='center'><a href='ViewAllUsers.asp?ValStat=A&RecID="&rsDisp("userid")&"&emailid="&rsDisp("emailid1")&"'><font face='verdana' size='2'>Activate</font></a> | <a href='ViewAllUsers.asp?ValEditset=yes&RecID="&rsDisp("userid")&"'><font face='verdana' size='2'>Edit</font></a></td>")
							end if
						Response.Write ("</tr>")
						j=j+1
						no=no+1
