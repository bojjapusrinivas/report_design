                    ...
                    <div class="w-100 text-center ">
                        ...
                        <div class="w-100 ">
							...
							<%  companies_list=split(RSeventMain("companynames"),";")
								...
								next
								%>
								<li class='list_style'>View complete list at  <a href="www.StrategyR.com" style="color:#435FBD"> www.StrategyR.com</li>
                            </ul>
                        </div>
                    </div>
					<%end if%>
		...
		<div class="row mx-0">
			<div class="w-100 text-center mt-0 mb-1">
				<div class="col-12 ml-4">
					<h2 class="text-left font_02">COMPETITORS PROFILED - <%=RSeventMain("companies")%></h2>
						<div class="w-100 ">
							<ul class="p-0 m-0 d-flex flex-wrap flex-row  competitors">
								<%  companies_list=split(RSeventMain("companynames"),";")
									''response.write 	ubound(companies_list)
