...
<body id="press_report " class="py-2">
	...
	<div id="wapper" class="p-0 mx-auto border">
        ...
        <div class="col-5 p-2  left_block position-relative">
            ...
            <div class="w-100 position-absolute executive_image_block">
                <img src="img/executive_desing-02.jpg" class="executive_image mx-auto d-block"/>
            </div>
            <!---LOGO Block-->
            ...
            <div class="d-flex ml-5" style="margin-top:-32px">
                ...
                <div class="Outreach  d-flex flex-column justify-content-center  text-center">
					<img src="img/icon_01_white.svg" class="icon"/>
                    <h3 class="font_03 my-1 text-uppercase font-weight-bold text-white">Executive Pool </h3>
                    <h2 class="font_02 text-white"><%=RSeventMain("pool_outreach")%></h2>
                ...
                <div class="d-flex justify-content-center">
					...
					<img src="img/icon_02_white.svg" class="icon"/>
                    <h3 class="font_03 my-1 text-uppercase font-weight-bold text-white">PARTICIPANTS</h3>
                    <h2 class="font_02 text-white"><%=RSeventMain("Participants")%></h2>
                    </div>
                </div>
             ...
             <div class="w-100 text-left mt-2 mb-2">
                ...
                <div class="w-100 text-center  mb-3">
                    ...
                    <div class="w-100">
                        <ul class="p-0 m-0 d-flex flex-wrap flex-row  geographics">
                            ...
                            <li class="list_style">South Korea,</li>
				...
				<%end if%>
                    ...
                    <div class="w-100 d-flex">
                        ...
                        <ul class="p-0 m-0 d-flex flex-wrap flex-row  geographics">
                            <li class="list_style">Offline</li>
                            <li class="list_style">Online</li>
                        </ul>
                    </div>-->
                    ...
                    <div class="w-100 text-center ">
                        <h2 class="text-center font_02">COMPETITORS PROFILED - <%=RSeventMain("companies")%></h2>
                        <div class="w-100 ">
