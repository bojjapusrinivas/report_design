                                ...
                                <div class="show  my-3 w-100 p-0" id="questionnaire">
                                    ...
                                    <div class="shadow-sm border position-relitive" id="questionnaire_block">
                                            <div class="row text-primary  w-100 pb-2 mt-3 mb-0 text-center mt-0" id="questionnaire_title">
													...
													<h3 class="font-weight-bold  line-height-normal">DIVERSITY - EQUITY - INCLUSION</h3>
                                            </div>
        ...
        <textarea class="form-control  text-area-block" id="ans_3" rows="2"></textarea>
                                            ...
                                            <div class="question mt-2 mb-3 p-2" data-question="3">
                                                ...
                                                <div class="w-100 mt-1">
                                                    ...
                                                    <div class="d-flex mb-2 flex-wrap left_margin ">
                                                        <div class="mr-1 d-flex ">
                                                            <span class="no_span "> <input class="form-check-input mt-1" name="exampleRadios21" type="radio"   > </span> 
...
<div id="submit_model" class="modal rounded-0">
    <div class="border_shadow w-100 pb-3">
        <div class="py-1 border-bottom">
            <h4 class=" text-center P-1 font-weight-bold font-size-15 mb-1" style="color: #E37038; line-height: normal; ">PLEASE LOGIN</h4>
        ...
        <div class="w-lg-70 w-xl-70 w-md-80 w-sm-100 mx-auto p-2">
            <form>
                <div class="form-group mb-1 ">
                  ...
                  <input type="text" class="form-control w-100" id="exampleInputEmail1" aria-describedby="emailHelp"  value="<%=session("FirstName")%>">
                  
                </div>
                <div class="form-group mb-1" >
                  <label for="exampleInputPassword1" class="font-weight-bold mt-3"><span class="red_color">*</span> Last Name</label>
                  <input type="text" class="form-control w-100" id="exampleInputPassword1" value="<%=session("LastName")%>">
                </div>
                <div class="form-group" >
                    <label for="exampleInputPassword1" class="font-weight-bold mt-3"><span class="red_color">*</span> Company Domain Email</label>
                    <input type="email" class="form-control w-100" id="exampleInputPassword1" value="<%=session("EID")%>">
                  </div>
             ...
             <div class="w-100 text-center mt-3">
                <a href="#" class="button1 p-2 rounded-0 shadow mx-0  "   rel="modal:close" style="width:38px !important; color: #fff;">GO</a>
             </div>
