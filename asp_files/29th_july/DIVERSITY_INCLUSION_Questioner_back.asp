...
<div class="container ">
										 ...
										 <h3 class="d-block w-xl-95 w-lg-95 w-md-100 w-sm-100 w-100 mx-auto mt-0 mb-2 p-2 ">Do We Need More Than One Planet to Support Our Business Activities & Operations?
                                            ...
                                            <div class="mt-2 w-100">
                                                ...
                                                <form id="examwizard-question2">
                                                    ...
                                                    <div class="question mt-2 mb-3 p-2 " data-question="1">
                                                            ...
                                                            <div class="w-100  p-2">
                                                                ...
                                                                <h4 class="question-title">Right now Global Industry Analysts, Inc. does not have an established definition of DEI as we know it differs for every organization. We encourage you to share your own unique definition in the context of your organization’s goals and mission. </h4>
                                                                </span>
                                                             </div>
                                                            </div>

                                                            <div class="w-100 mt-2">
                                                                <textarea class="form-control  text-area-block" id="ans_1" rows="2"></textarea>
                                                            </div>
                                                    ...
                                                    <div class="question mt-2 mb-3 p-2" data-question="2">
                                                        <div class="w-100  p-2 ">
                                                            ...
                                                            <div class="w-100 p-2">
                                                                <h5 class="px-3 note_msg"><span style="color:red">*</span> If Yes, please rank each of the parameter</h5>
                                                            </div>
                                                             ...
                                                             <ul class="mt-2 list">
                                                              ...
                                                              <li class="d-flex flex-column">
                                                                ...
                                                                <div class="d-flex mb-1 flex-lg-nowrap flex-xl-nowrap flex-md-wrap flex-sm-wrap flex-wrap ">
                                                                    <div class="d-flex six columns mb-2">
                                                                            <span class="no_span ">(i) </span> <span class="question_span">Recruitment</span>
                                                                    </div>

                                                                    <div class="eight columns mb-2 ">
                                                                        <div class="d-flex mb-2 flex-wrap left_margin ">
                                                                            <div class="mr-1 d-flex ">
                                                                                <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup1" type="radio" value="yes" > </span> 
                                                                                <span class="question_span ml-0 ">Yes      </span> 
                                                                            </div>
        
                                                                            <div class="mr-1 d-flex">
                                                                                <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup1" type="radio"  value="no" > </span> 
                                                              ...
                                                              <li class="d-flex flex-column">
                                                                ...
                                                                <div class="d-flex mb-1 flex-lg-nowrap flex-xl-nowrap flex-md-wrap flex-sm-wrap flex-wrap ">
                                                                    <div class="d-flex six columns mb-2">
                                                                            <span class="no_span ">(ii) </span> <span class="question_span">Training and Educating People</span>
                                                                    </div>

                                                                    <div class="eight columns mb-2 ">
                                                                        <div class="d-flex mb-2 flex-wrap left_margin ">
                                                                            <div class="mr-1 d-flex ">
                                                                                <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup2" type="radio" value="yes" > </span> 
                                                                                <span class="question_span ml-0 ">Yes      </span> 
                                                                            </div>
        
                                                                            <div class="mr-1 d-flex">
                                                                                <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup2" type="radio"  value="no" > </span> 
                                                                                <span class="question_span ml-0 ">No  </span> 
                                                                            </div>
                                                               ...
                                                               <li class="d-flex flex-column">
                                                                ...
                                                                <div class="d-flex mb-1 flex-lg-nowrap flex-xl-nowrap flex-md-wrap flex-sm-wrap flex-wrap ">
                                                                    <div class="d-flex six columns mb-2">
                                                                            <span class="no_span ">(iii) </span> <span class="question_span">Empowering Employees </span>
                                                                    </div>

                                                                    <div class="eight columns mb-2 ">
                                                                        <div class="d-flex mb-2 flex-wrap left_margin ">
                                                                            <div class="mr-1 d-flex ">
                                                                                <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup3" type="radio" value="yes" > </span> 
                                                                                <span class="question_span ml-0 ">Yes      </span> 
                                                                            </div>
        
                                                                            <div class="mr-1 d-flex">
                                                                                <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup3" type="radio"  value="no" > </span> 
                                                                                <span class="question_span ml-0 ">No  </span> 
                                                                            </div>
                                                               ...
                                                               <li class="d-flex flex-column">
                                                                ...
                                                                <div class="d-flex mb-1 flex-lg-nowrap flex-xl-nowrap flex-md-wrap flex-sm-wrap flex-wrap ">
                                                                    <div class="d-flex six columns mb-2">
                                                                            <span class="no_span ">(iv) </span> <span class="question_span">Rethinking Workforce Policies</span>
                                                                    </div>

                                                                    <div class="eight columns mb-2 ">
                                                                        <div class="d-flex mb-2 flex-wrap left_margin ">
                                                                            <div class="mr-1 d-flex ">
                                                                                <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup4" type="radio" value="yes" > </span> 
                                                                                <span class="question_span ml-0 ">Yes      </span> 
                                                                            </div>
        
                                                                            <div class="mr-1 d-flex">
                                                                                <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup4" type="radio"  value="no" > </span> 
                                                                                <span class="question_span ml-0 ">No  </span> 
                                                                            </div>
                                                               ...
                                                               <li class="d-flex flex-column">
                                                                ...
                                                                <div class="d-flex mb-1 flex-lg-nowrap flex-xl-nowrap flex-md-wrap flex-sm-wrap flex-wrap ">
                                                                    <div class="d-flex six columns mb-2">
                                                                            <span class="no_span ">(v) </span> <span class="question_span">Communicating Inclusion Goals and Measuring Progress </span>
                                                                    </div>

                                                                    <div class="eight columns mb-2 ">
                                                                        <div class="d-flex mb-2 flex-wrap left_margin ">
                                                                            <div class="mr-1 d-flex ">
                                                                                <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup5" type="radio" value="yes" > </span> 
                                                                                <span class="question_span ml-0 ">Yes      </span> 
                                                                            </div>
        
                                                                            <div class="mr-1 d-flex">
                                                                                <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup5" type="radio"  value="no" > </span> 
                                                                                <span class="question_span ml-0 ">No  </span> 
                                                                            </div>
                                                               ...
                                                               <li class="d-flex flex-column">
                                                                ...
                                                                <div class="d-flex mb-1 flex-lg-nowrap flex-xl-nowrap flex-md-wrap flex-sm-wrap flex-wrap ">
                                                                    <div class="d-flex six columns mb-2">
                                                                            <span class="no_span ">(vi) </span> <span class="question_span">Celebrating Individual Differences</span>
                                                                    </div>

                                                                    <div class="eight columns mb-2 ">
                                                                        <div class="d-flex mb-2 flex-wrap left_margin ">
                                                                            <div class="mr-1 d-flex ">
                                                                                <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup6" type="radio" value="yes" > </span> 
                                                                                <span class="question_span ml-0 ">Yes      </span> 
                                                                            </div>
        
                                                                            <div class="mr-1 d-flex">
                                                                                <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup6" type="radio"  value="no" > </span> 
                                                                                <span class="question_span ml-0 ">No  </span> 
                                                                            </div>
                                                        ...
                                                        <div class="w-100 mt-1 ">
                                                            <div class="w-100 left_margin">
                                                                <label data-toggle="collapse" data-target="#comment_02" aria-expanded="false" aria-controls="collapseOne">
                                                            ...
                                                            <div id="comment_02" aria-expanded="false" class="collapse">
                                                                <textarea class="form-control  text-area-block" id="ans_3" rows="2"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="question mt-2 mb-3 p-2" data-question="3">
                                                            ...
                                                            <div class="w-100 mt-2">
                                                                <div class="d-flex mb-2 flex-wrap left_margin ">
                                                                    <div class="mr-1 d-flex ">
                                                                        <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup7" type="radio"   value="yes" > </span> 
                                                                        <span class="question_span ml-0 ">Very Willing      </span> 
                                                                    </div>

                                                                    <div class="mr-1 d-flex">
                                                                        <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup7" type="radio"   value="no" ></span> 
                                                                    ...
                                                                    <div class="mr-1 d-flex">
                                                                        <p class="pl-1 note_msg"><span style="color:red">*</span> If Willing, Please Rank</p>
                                                                    </div>
                                                            ...
                                                            <div class="w-100 left_margin">
                                                                <label data-toggle="collapse" data-target="#comment_03" aria-expanded="false" aria-controls="collapseOne">
                                                                    <input type="checkbox" class="comment_checkbox"/> <span class="comment">Comments</span>
                                                                </label>
                                                            </div>
                                                    ...
                                                    <div class="question mt-2 mb-3 p-2" data-question="3">
                                                        ...
                                                        <div class="w-100 mt-2">
                                                            <div class="d-flex mb-2 flex-wrap left_margin ">
                                                                <div class="mr-1 d-flex ">
                                                                    <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup8" type="radio"   value="yes" ></span> 
                                                                    <span class="question_span ml-0 ">Yes      </span> 
                                                                </div>

                                                                <div class="mr-1 d-flex">
                                                                    <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup8" type="radio"   value="no" > </span> 
                                                                    <span class="question_span ml-0 ">No    </span> 
                                                                </div>
                                                                ...
                                                                <div class="mr-1 d-flex">
                                                                    <p class="pl-1 note_msg"><span style="color:red">*</span> If Yes, Please Rank</p>
                                                                </div>
                                                        ...
                                                        <div class="w-100 left_margin">
                                                            <label data-toggle="collapse" data-target="#comment_04" aria-expanded="false" aria-controls="collapseOne">
                                                                <input type="checkbox" class="comment_checkbox"/> <span class="comment">Comments</span>
                                                            </label>
                                                        </div>
                                                ...
                                                <div class="question mt-2 mb-3 p-2" data-question="3">
                                                    ...
                                                    <div class="w-100 mt-2">
                                                        <div class="d-flex mb-2 flex-wrap left_margin ">
                                                            <div class="mr-1 d-flex ">
                                                                <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup9" type="radio"   value="yes" > </span> 
                                                                <span class="question_span ml-0 ">Yes      </span> 
                                                            </div>

                                                            <div class="mr-1 d-flex">
                                                                <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup9" type="radio"   value="no" > </span> 
                                                                <span class="question_span ml-0 ">No    </span> 
                                                            </div>
                                                    ...
                                                    <div class="w-100 left_margin">
                                                        <label data-toggle="collapse" data-target="#comment_05" aria-expanded="false" aria-controls="collapseOne">
                                                            <input type="checkbox" class="comment_checkbox"/> <span class="comment">Comments</span>
                                                        </label>
                                                    </div>
                                            ...
                                            <div class="question mt-2 mb-3 p-2" data-question="3">
                                                ...
                                                <div class="w-100 mt-2">
                                                    <div class="d-flex mb-2 flex-wrap left_margin ">
                                                        <div class="mr-1 d-flex ">
                                                            <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup10" type="radio"   value="yes" > </span> 
                                                            <span class="question_span ml-0 ">Yes      </span> 
                                                        </div>

                                                        <div class="mr-1 d-flex">
                                                            <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup10" type="radio"   value="no" > </span> 
                                                            <span class="question_span ml-0 ">No    </span> 
                                                        </div>
                                                ...
                                                <div class="w-100 left_margin">
                                                    <label data-toggle="collapse" data-target="#comment_06" aria-expanded="false" aria-controls="collapseOne">
                                                        <input type="checkbox" class="comment_checkbox"/> <span class="comment">Comments</span>
                                                    </label>
                                                </div>
                                        ...
                                        <div class="question mt-2 mb-3 p-2 " data-question="1">
                                         ...
                                         <div class="question mt-2 mb-3 p-2" data-question="3">
                                            ...
                                            <div class="w-100 mt-2">
                                                <div class="d-flex mb-2 flex-wrap left_margin ">
                                                    <div class="mr-1 d-flex ">
                                                        <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup11" type="radio"   value="yes" > </span> 
                                                        <span class="question_span ml-0 ">Yes      </span> 
                                                    </div>

                                                    <div class="mr-1 d-flex">
                                                        <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup11" type="radio"   value="no" > </span> 
                                                        <span class="question_span ml-0 ">No    </span> 
                                                    </div>
                                            ...
                                            <div class="w-100 left_margin">
                                                <label data-toggle="collapse" data-target="#comment_08" aria-expanded="false" aria-controls="collapseOne">
                                                    <input type="checkbox" class="comment_checkbox"/> <span class="comment">Comments</span>
                                                </label>
                                            </div>
                                          ...
                                          <div class="question mt-2 mb-3 p-2" data-question="3">
                                            ...
                                            <div class="w-100 mt-2">
                                                <div class="d-flex mb-2 flex-wrap left_margin ">
                                                    <div class="mr-1 d-flex ">
                                                        <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup12" type="radio"   value="yes" > </span> 
                                                        <span class="question_span ml-0 ">Yes      </span> 
                                                    </div>

                                                    <div class="mr-1 d-flex">
                                                        <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup12" type="radio"   value="no" ></span> 
                                                        <span class="question_span ml-0 ">No    </span> 
                                                    </div>
                                            ...
                                            <div class="w-100 left_margin">
                                                <label data-toggle="collapse" data-target="#comment_09" aria-expanded="false" aria-controls="collapseOne">
                                                    <input type="checkbox" class="comment_checkbox"/> <span class="comment">Comments</span>
                                                </label>
                                            </div>
                                         ...
                                         <div class="question mt-2 mb-3 p-2" data-question="3">
                                            ...
                                            <div class="w-100 mt-2">
                                                <div class="d-flex mb-2 flex-wrap left_margin ">
                                                    <div class="mr-1 d-flex ">
                                                        <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup13" type="radio"   value="yes" > </span> 
                                                        <span class="question_span ml-0 ">Yes      </span> 
                                                    </div>

                                                    <div class="mr-1 d-flex">
                                                        <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup13" type="radio"   value="no" > </span> 
                                                        <span class="question_span ml-0 ">No    </span> 
                                                    </div>
                                            ...
                                            <div class="w-100 left_margin">
                                                <label data-toggle="collapse" data-target="#comment_10" aria-expanded="false" aria-controls="collapseOne">
                                                    <input type="checkbox" class="comment_checkbox"/> <span class="comment">Comments</span>
                                                </label>
                                            </div>
                                          ...
                                          <div class="question mt-2 mb-3 p-2" data-question="3">
                                            ...
                                            <div class="w-100 mt-2">
                                                <div class="d-flex mb-2 flex-wrap left_margin ">
                                                    <div class="mr-1 d-flex ">
                                                        <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup14" type="radio"   value="yes" > </span> 
                                                        <span class="question_span ml-0 ">Very Important        </span> 
                                                    </div>

                                                    <div class="mr-1 d-flex">
                                                        <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup14" type="radio"   value="no" > </span> 
                                                    ...
                                                    <div class="mr-1 d-flex">
                                                        <p class="pl-1 note_msg"><span style="color:red">*</span> If Important, Please Rank</p>
                                                    </div>
                                            ...
                                            <div class="w-100 left_margin">
                                                <label data-toggle="collapse" data-target="#comment_11" aria-expanded="false" aria-controls="collapseOne">
                                                    <input type="checkbox" class="comment_checkbox"/> <span class="comment">Comments</span>
                                                </label>
                                            </div>
                                          ...
                                          <div class="question mt-2 mb-3 p-2" data-question="3">
                                            ...
                                            <div class="w-100 mt-2">
                                                <div class="d-flex mb-2 flex-wrap left_margin ">
                                                    <div class="mr-1 d-flex ">
                                                        <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup15" type="radio"   value="yes" ></span> 
                                                        <span class="question_span ml-0 ">Yes      </span> 
                                                    </div>

                                                    <div class="mr-1 d-flex">
                                                        <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup15" type="radio"   value="no" ></span> 
                                                        <span class="question_span ml-0 ">No    </span> 
                                                    </div>
                                            ...
                                            <div class="w-100 left_margin">
                                                <label data-toggle="collapse" data-target="#comment_12" aria-expanded="false" aria-controls="collapseOne">
                                                    <input type="checkbox" class="comment_checkbox"/> <span class="comment">Comments</span>
                                                </label>
                                            </div>
                                           ...
                                           <div class="question mt-2 mb-3 p-2" data-question="3">
                                            ...
                                            <div class="w-100 left_margin">
                                                <label data-toggle="collapse" data-target="#comment_13" aria-expanded="false" aria-controls="collapseOne">
                                                    <input type="checkbox" class="comment_checkbox"/> <span class="comment">Comments</span>
                                                </label>
                                            </div>
                                           ...
                                           <div class="question mt-2 mb-3 p-2" data-question="3">
                                            ...
                                            <div class="w-100 mt-2">
                                                <div class="d-flex mb-2 flex-wrap left_margin ">
                                                    <div class="mr-1 d-flex ">
                                                        <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup24" type="radio"   value="yes" > </span> 
                                                        <span class="question_span ml-0 ">Yes      </span> 
                                                    </div>

                                                    <div class="mr-1 d-flex">
                                                        <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup24" type="radio"   value="no" ></span> 
                                                        <span class="question_span ml-0 ">No    </span> 
                                                    </div>
                                            ...
                                            <div class="w-100 left_margin">
                                                <label data-toggle="collapse" data-target="#comment_14" aria-expanded="false" aria-controls="collapseOne">
                                                    <input type="checkbox" class="comment_checkbox"/> <span class="comment">Comments</span>
                                                </label>
                                            </div>
                                            ...
                                            <div class="question mt-2 mb-3 p-2" data-question="3">
                                                ...
                                                <div class="w-100 mt-2">
                                                    <div class="d-flex mb-2 flex-wrap left_margin ">
                                                        <div class="mr-1 d-flex ">
                                                            <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup25" type="radio"   value="yes" > </span> 
                                                            <span class="question_span ml-0 ">Very Likely        </span> 
                                                        </div>
    
                                                        <div class="mr-1 d-flex">
                                                            <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup25" type="radio"   value="no" > </span> 
                                                ...
                                                <div class="w-100 left_margin">
                                                    <label data-toggle="collapse" data-target="#comment_15" aria-expanded="false" aria-controls="collapseOne">
                                                        <input type="checkbox" class="comment_checkbox"/> <span class="comment">Comments</span>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="question mt-2 mb-3 p-2" data-question="3">
                                                ...
                                                <div class="w-100 mt-2">
                                                    <div class="d-flex mb-2 flex-wrap left_margin ">
                                                        <div class="mr-1 d-flex ">
                                                            <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup26" type="radio"   value="yes" > </span> 
                                                            <span class="question_span ml-0 ">Yes      </span> 
                                                        </div>
    
                                                        <div class="mr-1 d-flex">
                                                            <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup26" type="radio"   value="no" > </span> 
                                                            <span class="question_span ml-0 ">No    </span> 
                                                        </div>
                                                ...
                                                <div class="w-100 left_margin">
                                                    <label data-toggle="collapse" data-target="#comment_16" aria-expanded="false" aria-controls="collapseOne">
                                                        <input type="checkbox" class="comment_checkbox"/> <span class="comment">Comments</span>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="question mt-2 mb-3 p-2" data-question="3">
                                                ...
                                                <div class="w-100 mt-2">
                                                    <div class="d-flex mb-2 flex-wrap left_margin ">
                                                        <div class="mr-1 d-flex ">
                                                            <span class="no_span "><input class="form-check-input mt-1" name="collapseGroup27" type="radio"   value="yes" > </span> 
                                                            <span class="question_span ml-0 ">Yes      </span> 
                                                        </div>
    
                                                        <div class="mr-1 d-flex">
                                                            <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup27" type="radio"   value="no" ></span> 
                                                            <span class="question_span ml-0 ">No    </span> 
                                                        </div>
                                                ...
                                                <div class="w-100 left_margin">
                                                    <label data-toggle="collapse" data-target="#comment_17" aria-expanded="false" aria-controls="collapseOne">
                                                        <input type="checkbox" class="comment_checkbox"/> <span class="comment">Comments</span>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="question mt-2 mb-3 p-2" data-question="3">
                                                ...
                                                <div class="w-100 mt-2">
                                                    <ul class="mt-2   list ">
                                                        <li class="d-flex mb-1"><span class="no_span "> <input class="form-check-input mt-1 ml-0" type="radio" name="exampleRadios21" id="exampleRadios1" value="option1" checked=""> </span> <span class="question_span ml-0 ">A structured DEI initiative  </span> </li>
                                                        <li class="d-flex mb-1"><span class="no_span "> <input class="form-check-input mt-1 ml-0" type="radio" name="exampleRadios21" id="exampleRadios1" value="option1"></span> <span class="question_span ml-0 "> An informal or adhoc DEI initiative</span> </li>
                                                        <li class="d-flex mb-1"><span class="no_span "> <input class="form-check-input mt-1 ml-0" type="radio" name="exampleRadios21" id="exampleRadios1" value="option1"></span> <span class="question_span ml-0 "> 	Have no DEI practice in place     </span> </li>
                                                        
                                                    </ul>
                                                </div>
                                              
                                                <div class="w-100 left_margin">
                                                    <label data-toggle="collapse" data-target="#comment_18" aria-expanded="false" aria-controls="collapseOne">
                                                        <input type="checkbox" class="comment_checkbox"/> <span class="comment">Comments</span>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="question mt-2 mb-3 p-2" data-question="3">
                                                ...
                                                <div class="w-100 mt-2">
                                                    <div class="d-flex mb-2 flex-wrap left_margin ">
                                                        <div class="mr-1 d-flex ">
                                                            <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup28" type="radio"   value="yes" > </span> 
                                                            <span class="question_span ml-0 ">Yes      </span> 
                                                        </div>
    
                                                        <div class="mr-1 d-flex">
                                                            <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup28" type="radio"   value="no" > </span> 
                                                            <span class="question_span ml-0 ">No    </span> 
                                                        </div>
                                                ...
                                                <div class="w-100 left_margin">
                                                    <label data-toggle="collapse" data-target="#comment_19" aria-expanded="false" aria-controls="collapseOne">
                                                        <input type="checkbox" class="comment_checkbox"/> <span class="comment">Comments</span>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="question mt-2 mb-3 p-2" data-question="3">
                                                ...
                                                <div class="w-100 left_margin">
                                                    <label data-toggle="collapse" data-target="#comment_20" aria-expanded="false" aria-controls="collapseOne">
                                                        <input type="checkbox" class="comment_checkbox"/> <span class="comment">Comments</span>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="question mt-2 mb-3 p-2" data-question="3">
                                                ...
                                                <div class="w-100 mt-2">
                                                    <div class="d-flex mb-2 flex-wrap ">
                                                        <ul class="mt-2   list ">
                                                            <li class="d-flex mb-1"><span class="no_span "> <input class="form-check-input mt-1 ml-0" type="checkbox" name="exampleRadios21" id="exampleRadios1" value="option1"> </span> <span class="question_span ml-0 ">Effective risk-management practices. Women really help improve investment efficiency and prevent risky overinvestment decisions.</span> </li>
                                                            <li class="d-flex mb-1"><span class="no_span "> <input class="form-check-input mt-1 ml-0" type="checkbox" name="exampleRadios21" id="exampleRadios1" value="option1"></span> <span class="question_span ml-0 "> Fewer or reduced risk of fraud and earnings manipulation.       </span> </li>
                                                            <li class="d-flex mb-1"><span class="no_span "> <input class="form-check-input mt-1 ml-0" type="checkbox" name="exampleRadios21" id="exampleRadios1" value="option1"></span> <span class="question_span ml-0 ">Improved protection of stakeholder interests.   </span> </li>
                                                            <li class="d-flex mb-1"><span class="no_span "> <input class="form-check-input mt-1 ml-0" type="checkbox" name="exampleRadios21" id="exampleRadios1" data-toggle="collapse" data-target="#text_area_21_01" aria-expanded="false" aria-controls="comment_21_01"></span> <span class="question_span ml-0 ">Any other benefit? Specify    </span> </li>
                                                        </ul>
                                                ...
                                                <div class="w-100 left_margin">
                                                    <label data-toggle="collapse" data-target="#comment_21" aria-expanded="false" aria-controls="collapseOne">
                                                        <input type="checkbox" class="comment_checkbox"/> <span class="comment">Comments</span>
                                                    </label>
                                                </div>
  ...
  <div class="question mt-2 mb-3 p-2" data-question="3">
    ...
    <div class="w-100 mt-2">
        <div class="d-flex mb-2 flex-wrap left_margin ">
            <div class="mr-1 d-flex ">
                <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup36" type="radio"   value="yes" > </span> 
                <span class="question_span ml-0 ">Very Likely        </span> 
            </div>

            <div class="mr-1 d-flex">
                <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup36" type="radio"   value="no" ></span> 
                <span class="question_span ml-0 ">Not Likely       </span> 
            </div>
            ...
            <div class="mr-1 d-flex">
                <p class="pl-1 note_msg"><span style="color:red">*</span> If Likely, Please Rank</p>
            </div>
    ...
    <div class="w-100 left_margin">
        <label data-toggle="collapse" data-target="#comment_22" aria-expanded="false" aria-controls="collapseOne">
            <input type="checkbox" class="comment_checkbox"/> <span class="comment">Comments</span>
        </label>
    </div>
        ...
        <textarea class="form-control  text-area-block" id="ans_3" rows="2"></textarea>
                                            ...
                                            <div class="question mt-2 mb-3 p-2" data-question="3">
                                                ...
                                                <div class="w-100 mt-2">
                                                    <div class="d-flex mb-2 flex-wrap left_margin ">
                                                        <div class="mr-1 d-flex ">
                                                            <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup37" type="radio"   value="yes" > </span> 
                                                            <span class="question_span ml-0 ">Yes      </span> 
                                                        </div>
    
                                                        <div class="mr-1 d-flex">
                                                            <span class="no_span "> <input class="form-check-input mt-1" name="collapseGroup37" type="radio"   value="no" > </span> 
                                                            <span class="question_span ml-0 ">No    </span> 
                                                        </div>
                                                ...
                                                <div class="w-100 left_margin">
                                                    <label data-toggle="collapse" data-target="#comment_23" aria-expanded="false" aria-controls="collapseOne">
                                                        <input type="checkbox" class="comment_checkbox"/> <span class="comment">Comments</span>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="question mt-2 mb-3 p-2" data-question="3">
                                                ...
                                                <div class="w-100 mt-1">
                                                    <ul class="mt-2   list ">
                                                        <li class="d-flex mb-1"><span class="no_span "> <input class="form-check-input mt-1 ml-0" type="radio" name="exampleRadios21" id="exampleRadios1" value="option1" checked=""> </span> <span class="question_span ml-0 ">5% </span> </li>
                                                        <li class="d-flex mb-1"><span class="no_span "> <input class="form-check-input mt-1 ml-0" type="radio" name="exampleRadios21" id="exampleRadios1" value="option1"></span> <span class="question_span ml-0 "> More than 5%  </span> </li>
                                                        <li class="d-flex mb-1"><span class="no_span "> <input class="form-check-input mt-1 ml-0" type="radio" name="exampleRadios21" id="exampleRadios1" value="option1"></span> <span class="question_span ml-0 "> Less than 5%   </span> </li>
                                                ...
                                                <div class="w-100 left_margin">
                                                    <label data-toggle="collapse" data-target="#comment_24" aria-expanded="false" aria-controls="collapseOne" class="ml-1 mt-2">
                                                        <input type="checkbox" class="pl-3"/> <span class="comment">Comments</span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="w-100  p-2">
                                                    <div class="d-flex  justify-content-start">
                                                        ...
                                                        <span class="question_span ">
                                                        <h4 class="question-title">Finally, how would you rate the success of your corporate DEI policies?   </h4>
                                                        </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="w-100 left_margin pl-1">
                                                    <label data-toggle="collapse" data-target="#comment_25" aria-expanded="false" aria-controls="collapseOne">
                                                        <input type="checkbox" class="comment_checkbox"/> <span class="comment">Comments</span>
                                                    </label>
                                                </div>
             ...
             <tbody>							
               ...
               <tr align="center">
                 ...
                 <td height="40" align="left" class="td3"><div align="left">
                  <input type="text" class="txtbox140 w-xl-80 w-lg-80 w-md-80 w-sm-85" name="firstname" id="txtemailid" placeholder="First Name" size="50"  value="<%=session("FirstName")%>">
                 </div></td>
                 </tr>
               <tr align="center">
                 <td align="right" valign="middle" class="td1 font-weight-bold pt-2"><span class="red_color">*</span> Last Name:</td>
                 <td class="td2"></td>
                 <td height="40" align="left" class="td3"><input type="text" class="txtbox140 w-xl-80 w-lg-80 w-md-80 w-sm-85" name="lastname" id="lastname" maxlength="25" placeholder="Last Name" size="50"  value="<%=session("LastName")%>"></td>
                 </tr>

                 <tr align="center">
                    <td align="right" valign="middle" class="td1 font-weight-bold pt-2"><span class="red_color">*</span> Work Email:</td>
                    <td class="td2"></td>
                    <td height="40" align="left" class="td3"><input type="text" class="txtbox140 w-xl-80 w-lg-80 w-md-80 w-sm-85" name="email" id="txtpwd" maxlength="25" placeholder="Working Email" size="25" value="<%=session("EID")%>"></td>
                    </tr>
