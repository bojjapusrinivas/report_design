                                                ...
                                                <div class="mt-3 position-relative pb-1 d-flex flex-column">
                                                    ...
                                                    <table id="Influencer_table" class="border-0">
														...
														If instr(person_Designation,"diversity")>0 Then
															...
															Disp_Type_DEI = "DEI"
														elseIf instr(person_Designation,"carbon")>0 Then	
															Disp_Value = "influencer in Carbon Footprint"
															Disp_Type_Carbon = "CF"
														elseIf instr(person_Designation,"future")>0 Then	
                     ...
                     <tbody>
					  <tr>
                           <td style="background-color:#FFFFFF;"><br/>
                              <div class="w-100 text-center"> <h4 class="font-weight-bold">
									   <%
									   If trim(Disp_Type_DEI)="DEI" then
											response.write "<a href='https://www.strategyr.com/DEI_Survey.asp?stype=diversity'>Diversity Equity & Inclusion</a>"
										End If
										if  trim(Disp_Type_Carbon)="CF" then
											response.write "<a href='https://www.strategyr.com/CF_Survey.asp?stype=carbon footprint'>Carbon Footprint</a>"
										End If
										if trim(Disp_Type_FOW)="FOW" then
											response.write "<a href='https://www.strategyr.com/FOW_Survey.asp?stype=FUTURE OF WORK'>Future of Work</a>"	
										End If
										if  trim(Disp_Type_GENZ)="GZ" then
											response.write "<a href='https://www.strategyr.com/GZ_Survey.asp?stype=GENERATION Z'>Generation Z</a>"	
										End If
									   %></h4>
									   </div>
...
<div id="linkedin_mobel">
	...
	<!--p class="text-center">For a 2-stage verification.</p-->
	  <p class="text-center" style="font-size: 15px; font-weight: bold;">For a 2-Stage verification process, please sign in with LinkedIn below</p>
	   <a href="LogInUsingLinkedinApp/loginLinkedin1.asp?"><img src="images/linkedin.svg" class="mx-auto" style="width: 165px;"></a>
