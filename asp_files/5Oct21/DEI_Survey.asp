                            ...
                            <!---BEGIN:COLLAPSE-->
                                <div class="show  my-3 w-100 p-0" id="survey_template">
                                    ...
                                    <div class="position-relitive">
                                            <div class="row text-primary  w-100 pb-2 mt-3 mb-0 text-center mt-0" id="survey_title">
                                                    <h2 class="mt-3 px-3 p-0">DIVERSITY - EQUITY - INCLUSION</h2>
                                            ...
                                            <div class="mt-2 w-100">
                                                ...
                                                <p class="  mb-3">
                                                    Enterprise executives are invited to participate in our ongoing survey of this trending topic of great interest. Our survey results are published in a comprehensive quarterly report . More than 600K executives are engaged from about 72K companies worldwide. </p>
                        
                                                    <p class="  mb-3">  
                        
                                                    Participants are offered complimentary trending data, influencer insights, and an executive summary of our study findings. Participants also receive a 20% discount on annual subscription to our program which includes quarterly published reports. 
													...
													<div class="row">                                                    
                                                            <div class="w-100 ">
																...
																<%if session("EID") <>"" then%>
																<a href="DIVERSITY_INCLUSION_QUESTIONNAIRE.asp"  class="rounded-0    btn_type_03 "  type="submit"  name="btnsubmit" value="OK"  >SURVEY</a>
																<%else%>
																<a href="https://www.strategyr.com/LoginRepeat.asp" class="rounded-0     btn_type_03 "    type="submit"  name="btnsubmit" value="OK"  >SURVEY</a>
																<%end if%>
																
																<%if session("EID") <>"" then%>
																<a href="javascript:void(0)"     class="rounded-0    btn_type_03 " type="submit"  name="btnsubmit" value="OK"  >TRENDS</a>
																<%else%>
																<a href="https://www.strategyr.com/LoginRepeat.asp"  class="rounded-0     btn_type_03 "  type="submit"  name="btnsubmit" value="OK"  >TRENDS</a>
																<%end if%>
															
																<%if session("EID") <>"" then%>
																<a href="https://www.strategyr.com/Survey_Influencers.asp"  class="rounded-0     btn_type_03 " type="submit"  name="btnsubmit" value="OK"  >INFLUENCERS</a>
																<%else%>
																<a href="https://www.strategyr.com/LoginRepeat.asp"  class="rounded-0     btn_type_03 "  type="submit"  name="btnsubmit" value="OK"  >INFLUENCERS</a>
																<%end if%>
															
																<a href="https://www.strategyr.com/market-report-diversity-and-inclusion-forecasts-global-industry-analysts-inc.asp"  class="rounded-0     btn_type_03 "  type="submit"  name="btnsubmit" value="OK" style="background: #23B14D !important;"  >REPORT</a>
                                                    ...
                                                    <div class="row">                                                    
                                                            <div class="w-100  p-2">
                                                                ...
                                                                <span class="question_span "> <span class="text-danger">*</span> Login to view what's trending, influencer insights and to participate in our ongoing survey.</span>
