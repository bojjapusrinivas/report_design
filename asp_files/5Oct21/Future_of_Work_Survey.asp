...
================================================== -->
<meta charset="utf-8">
<title>DEI - Diversity, Equity and Inclusion - Validated Employee Survey - StrategyR.com</title>
	...
	<div class="w-100">
		<div class="row mb-0 mx-0">
			...
			<!-- <div class="d-flex flex-md-row flex-sm-row  justify-content-center flex-lg-nowrap flex-xl-nowrap flex-md-nowrap flex-sm-wrap"
                            ...
                            <!---BEGIN:COLLAPSE-->
                                <div class="show  my-3 w-100 p-0" id="survey_template">
                                    ...
                                    <div class="shadow-sm border position-relitive" id="questionnaire_block">
                                            ...
                                            <div class="mt-2 w-100">
                                                    ...
                                                    <div class="question mt-2 mb-3 p-2 " data-question="1" style="background-color:#F0F0F0">                                                    
                                                            <div class="w-100 ">
                                                                <div class="d-flex  justify-content-start">
                                                                <span class="no_span "> &raquo;</span>
                                                                <span class="question_span "><h4 class="question-title">ABOUT SURVEY</h4>Enterprise executives are invited to participate in our ongoing survey of this trending topic of great interest. Our survey results are published in a comprehensive quarterly report . More than 600K executives are engaged from about 72K companies worldwide. </span>
...
<hr/>
													<div class="question mt-2 mb-3 p-2 " data-question="1" style="background-color:#F0F0F0">                                                    
                                                            <div class="w-100">
                                                                <div class="d-flex  justify-content-start">
                                                                <span class="no_span "> &raquo;</span>
                                                                <span class="question_span "><h4 class="question-title">GENERAL TRENDS</h4>Participants are offered complimentary trending data, influencer insights, and an executive summary of our study findings. Participants also receive a 20% discount on annual subscription to our program which includes quarterly published reports. </span>
                                                             </div>
                                                            </div> 
                                                    </div> 
<hr/>
													<!--<div class="question mt-2 mb-3 p-2 " data-question="1" style="background-color:#F0F0F0">                                                    
                                                            <div class="w-100">
                                                                <div class="d-flex  justify-content-start">
                                                                <span class="no_span "> &raquo;</span>
                                                                <span class="question_span "><h4 class="question-title">DASHBOARD</h4></span>
                                                             </div>
                                                            </div> 
                                                    </div> 
...
<hr/>-->
													...
													<div class="question mt-2 mb-3 p-2 " data-question="1">                                                    
                                                            <div class="w-100 ">
                                                                ...
                                                                <span class="question_span " style="text-align:center;">
																<%if session("EID") <>"" then%>
																<a href="DIVERSITY_INCLUSION_QUESTIONNAIRE.asp"  class="button1 p-2 rounded-0 shadow-sm " style="width:80px !important; color:#fff !important" type="submit" class="button1 p-2 rounded-0 shadow-sm" src="images/login.gif" name="btnsubmit" value="OK" style="width:80px !important" >SURVEY</a>
																<%else%>
																<a href="https://www.strategyr.com/LoginRepeat.asp"  class="button1 p-2 rounded-0 shadow-sm " style="width:80px !important; color:#fff !important" type="submit" class="button1 p-2 rounded-0 shadow-sm" src="images/login.gif" name="btnsubmit" value="OK" style="width:80px !important" >SURVEY</a>
																<%end if%>
																&nbsp;&nbsp;&nbsp;&nbsp;
																<%if session("EID") <>"" then%>
																<a href="javascript:void(0)"  class="button1 p-2 rounded-0 shadow-sm " style="width:80px !important; color:#fff !important" type="submit" class="button1 p-2 rounded-0 shadow-sm" src="images/login.gif" name="btnsubmit" value="OK" style="width:80px !important" >TRENDS</a>
																<%else%>
																<a href="https://www.strategyr.com/LoginRepeat.asp"  class="button1 p-2 rounded-0 shadow-sm " style="width:80px !important; color:#fff !important" type="submit" class="button1 p-2 rounded-0 shadow-sm" src="images/login.gif" name="btnsubmit" value="OK" style="width:80px !important" >TRENDS</a>
																<%end if%>
																&nbsp;&nbsp;&nbsp;&nbsp;
																<%if session("EID") <>"" then%>
																<a href="https://www.strategyr.com/Survey_Influencers.asp"  class="button1 p-2 rounded-0 shadow-sm " style="width:120px !important; color:#fff !important" type="submit" class="button1 p-2 rounded-0 shadow-sm" src="images/login.gif" name="btnsubmit" value="OK" style="width:80px !important" >INFLUENCERS</a>
																<%else%>
																<a href="https://www.strategyr.com/LoginRepeat.asp"  class="button1 p-2 rounded-0 shadow-sm " style="width:120px !important; color:#fff !important" type="submit" class="button1 p-2 rounded-0 shadow-sm" src="images/login.gif" name="btnsubmit" value="OK" style="width:80px !important" >INFLUENCERS</a>
																<%end if%>
																&nbsp;&nbsp;&nbsp;&nbsp;
																
																<a href="https://www.strategyr.com/market-report-diversity-and-inclusion-forecasts-global-industry-analysts-inc.asp"  class="button1 p-2 rounded-0 shadow-sm " style="width:80px !important; color:#fff !important" type="submit" class="button1 p-2 rounded-0 shadow-sm" src="images/login.gif" name="btnsubmit" value="OK" style="width:80px !important" >REPORT</a>
																&nbsp;&nbsp;&nbsp;&nbsp;
																</span>
                                                             </div>
                                                            </div> 
...
<div class="question mt-2 mb-3 p-2 " data-question="1">                                                    
                                                            <div class="w-100  p-2">
                                                                <div class="d-flex  justify-content-start">
                                                                <span class="question_span "> * Login to view what's trending, influencer insights and to participate in our ongoing survey.</span>
