							...
							columnheader'>OPTIONS</td>-->
								...
								<tbody role="rowgroup">
									<tr role="row">
										...
										<td role="cell" data-label="SUbject">Company to Report Final Verification Status</td>
										<td role="cell" data-label="MAIL-ID">padmaja@bizacumen.com</td>
										<td role="cell" data-label="MESSAGE">
		
											<span class="more">
											This is to update on the Company to Report Final Verification Status. The team
											completed a total of 25,395 companies to Report verification as of today. Of the 5
											and 5+ Report companies targeted, all the companies with more than 9 reports are
											done. The companies currently in queue are 8 and below 8 report companies. A total
											38 In-house support team members are tasked on this project. Few External
											Contractors are also being trained on the same task, and are initially targeted on 1
											report companies until they get used to, and later depending on their adoption to
											the process, they will be shifted to more report companies.
										</span>
										</td>
									</tr>
								</tbody>
