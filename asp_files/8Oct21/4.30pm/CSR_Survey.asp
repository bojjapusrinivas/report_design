                                ...
                                <div class="show  my-3 w-100 p-0" id="survey_template">
                                    ...
                                    <div class="position-relitive">
                                            ...
                                            <div class="row mb-2 w-lg-85 w-xl-85 w-md-100 w-sm-100 w-100 mx-auto">
                                                ...
                                                <p class="  mb-2">
                                                    Enterprise executives are invited to participate in our ongoing survey of this trending topic of great interest. Our survey results are published in a comprehensive quarterly report . More than 600K executives are engaged from about 72K companies worldwide.<br/>
                                                ...
                                                <div class="row mb-0">
													...
													<div class="row">                                                    
                                                            <div class="w-100 ">
																...
																<%if session("EID") <>"" then%>
																<a href="Influencer_CORPORATE_SOCIAL_RESPONSIBILITY.asp" style="color:#fff!important; font-weight:600" class="rounded-0    btn_type_03 "  type="submit"  name="btnsubmit" value="OK"  >SURVEY</a>
																<%else%>
