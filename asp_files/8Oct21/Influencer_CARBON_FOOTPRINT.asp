                                ...
                                <div class="collapse show my-3 w-100 p-0" id="questionnaire">
                                    ...
                                    <div class=" border position-relitive" id="questionnaire_block">
                                        <div class="row text-primary  w-100 pb-2 mt-3 mb-0 text-center mt-0"
                                            ...
                                            <h1 class="font-weight-bold  line-height-normal" style="color: #E37038;"> CARBON FOOTPRINT </h1>
                                        ...
                                        <h3 class="d-block w-xl-95 w-lg-95 w-md-100 w-sm-100 w-100 mx-auto mt-0 mb-2 p-2 "
                                            ...
                                            - Participants’ identities are never disclosed. Analyses by industry, rankings by company, and related trends and stats are published.
                                        </h3>
                                        <hr />
                                            ...
                                            <form id="questioner">
                                                ...
                                                <ul class="question mt-2 mb-3">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="ml">
                                                            ...
                                                            <div class="d-flex flex-wrap justify-content-start ">
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="radio" name="q1" id="q2_a">
                                                                    </div>
                                                                    <label>Yes </label>
                                                                </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    ...
                                                                    <div class="input_block">
                                                                        <input type="radio" name="q1" id="q2_b">
                                                                    </div>
                                                                    <label>No </label>
                                                                </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="radio" name="q1" id="q2_d">
                                                                    </div>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="ml">
                                                            ...
                                                            <div class="d-flex flex-wrap justify-content-start ">
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="radio" name="q1" id="q3_a">
                                                                    </div>
                                                                    <label>Yes </label>
                                                                </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    ...
                                                                    <div class="input_block">
                                                                        <input type="radio" name="q1" id="q3_b">
                                                                    </div>
                                                                    <label>No </label>
                                                                </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="radio" name="q1" id="q3_d">
                                                                    </div>
                                                                    <label>Don’t Know </label>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="ml mt-2 mb-4" id="q4_rank">
                                                            <div class="w-100 px-3">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="ml">
                                                            <div id="comment_12" aria-expanded="false" class="mt-1">
                                                                <textarea class="form-control  openion_field" id="comt_01"  rows="2"></textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <!--div class="ml mt-2">
                                                            <div class="mr-2 d-flex ">
                                                                <input type="checkbox" data-toggle="collapse"
                                                                    data-target="#comment_06" aria-expanded="false"
                                                                    aria-controls="collapseOne" />
                                                                <label>Comments </label>
                                                            </div>
        
                                                            <div id="comment_06" aria-expanded="false" class="collapse ">
                                                                <textarea class="form-control  w-100" id="commt_4"
                                                                    rows="2"></textarea>
                                                            </div>
                                                        </div--->
                                                     ...
                                                     <li>
                                                        <h4>Do you favor or oppose expanding each of the following sources of energy in our country</h4>
        
                                                        <div class="ml">
                                                            <div class="d-flex flex-column justify-content-start toggle">
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="checkbox"  data-toggle="collapse" data-target="#comment_7a" aria-expanded="false" aria-controls="collapseOne">
                                                                        </div>
                                                                    <label>More offshore oil and gas drilling </label> 
                                                                </div>
        
                                                                <div id="comment_7a" aria-expanded="false" class="collapse mb-2  ">
                                                                    <div class="w-100 px-3">
                                                                        <div class="ml">
                                                                            <div class="d-flex flex-wrap justify-content-start ">
                                                                                <div class="mr-2 d-flex options ">
                                                                                    <div class="input_block">
                                                                                        <input type="radio" name="q7_a"  id="7_a_favor">
                                                                                    </div>
                                                                                    <label>Favor </label>
                                                                                </div>
                                                                                ...
                                                                                <div class="mr-2 d-flex options">
                                                                                    <div class="input_block">
                                                                                        <input type="radio" name="q7_a"  id="7_a_Oppose">
                                                                                    </div>
                                                                                    <label>Oppose </label>
                                                                                </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="checkbox"  data-toggle="collapse" data-target="#comment_7b" aria-expanded="false" aria-controls="collapseOne">
                                                                        </div>
                                                                    <label>More nuclear power plants to generate electricity </label> 
                                                                </div>
        
                                                                <div id="comment_7b" aria-expanded="false" class="collapse mb-2   ">
                                                                    <div class="w-100 px-3">
                                                                        <div class="ml">
                                                                            <div class="d-flex flex-wrap justify-content-start toggle">
                                                                                <div class="mr-2 d-flex options ">
                                                                                    <div class="input_block">
                                                                                        <input type="radio" name="q7_b" customatt="radio_option" id="7_b_favor">
                                                                                    </div>
                                                                                    <label>Favor </label>
                                                                                </div>
                                                                                ...
                                                                                <div class="mr-2 d-flex options">
                                                                                    <div class="input_block">
                                                                                        <input type="radio" name="q7_b" customatt="radio_option" id="7_b_Oppose">
                                                                                    </div>
                                                                                    <label>Oppose </label>
                                                                                </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="checkbox"  data-toggle="collapse" data-target="#comment_7c" aria-expanded="false" aria-controls="collapseOne">
                                                                        </div>
                                                                    <label>More coal mining </label> 
                                                                </div>
        
                                                                <div id="comment_7c" aria-expanded="false" class="collapse mb-2  ">
                                                                    <div class="w-100 px-3">
                                                                        <div class="ml">
                                                                            <div class="d-flex flex-wrap justify-content-start toggle">
                                                                                <div class="mr-2 d-flex options ">
                                                                                    <div class="input_block">
                                                                                        <input type="radio" name="q7_c" customatt="radio_option" id="7_c_favor">
                                                                                    </div>
                                                                                    <label>Favor </label>
                                                                                </div>
                                                                                ...
                                                                                <div class="mr-2 d-flex options">
                                                                                    <div class="input_block">
                                                                                        <input type="radio" name="q7_c" customatt="radio_option" id="7_c_Oppose">
                                                                                    </div>
                                                                                    <label>Oppose </label>
                                                                                </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="checkbox"  data-toggle="collapse" data-target="#comment_7d" aria-expanded="false" aria-controls="collapseOne">
                                                                        </div>
                                                                    <label>More solar panel “farms”</label> 
                                                                </div>
        
                                                                <div id="comment_7d" aria-expanded="false" class="collapse mb-2   ">
                                                                    <div class="w-100 px-3">
                                                                        <div class="ml">
                                                                            <div class="d-flex flex-wrap justify-content-start toggle">
                                                                                <div class="mr-2 d-flex options ">
                                                                                    <div class="input_block">
                                                                                        <input type="radio" name="q7_d" customatt="radio_option" id="7_d_favor">
                                                                                    </div>
                                                                                    <label>Favor </label>
                                                                                </div>
                                                                                ...
                                                                                <div class="mr-2 d-flex options">
                                                                                    <div class="input_block">
                                                                                        <input type="radio" name="q7_d" customatt="radio_option" id="7_d_Oppose">
                                                                                    </div>
                                                                                    <label>Oppose </label>
                                                                                </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="checkbox"  data-toggle="collapse" data-target="#comment_7e" aria-expanded="false" aria-controls="collapseOne">
                                                                        </div>
                                                                    <label>More wind turbine “farms”</label> 
                                                                </div>
        
                                                                <div id="comment_7e" aria-expanded="false" class="collapse mb-2  " >
                                                                    <div class="w-100 px-3">
                                                                        <div class="ml">
                                                                            <div class="d-flex flex-wrap justify-content-start toggle">
                                                                                <div class="mr-2 d-flex options ">
                                                                                    <div class="input_block">
                                                                                        <input type="radio" name="q7_e" customatt="radio_option" id="7_e_favor">
                                                                                    </div>
                                                                                    <label>Favor </label>
                                                                                </div>
                                                                                ...
                                                                                <div class="mr-2 d-flex options">
                                                                                    <div class="input_block">
                                                                                        <input type="radio" name="q7_e" customatt="radio_option" id="7_e_Oppose">
                                                                                    </div>
                                                                                    <label>Oppose </label>
                                                                                </div>
                                                     ...
                                                     <li>
                                                        <h4>What percentage (%) energy used by your business comes from renewable energy sources? </h4>
                                                        ...
                                                        <div class="ml mt-2 mb-4 target" id="q8_rank">
                                                            <div class="w-100 ">
                                                                <input type="text" class="form-control  w-100" id="other_spacity" rows="1" style="width: 75px !important"></input>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <h4>Has your business ever considered installing solar panels to generate electricity for your offices and plants? </h4>
                                                        ...
                                                        <div class="ml mt-2 mb-4 target" id="q9_rank">
                                                            <div class="w-100 ">
                                                                <input type="text" class="form-control  w-100" id="other_spacity" rows="1" style="width: 200px !important"></input>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="ml">
                                                            <div class="d-flex flex-xs-column flex-wrap justify-content-start">
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="radio" name="q2" id="q10_a">
                                                                        </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="radio" name="q2" id="q10_b">
                                                                        </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="radio" name="q2" id="q10_c">
                                                                        </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="radio" name="q2" id="q10_d">
                                                                        </div>
                                                    ...
                                                    <li>
                                                        <h4>What are the best practices you think are necessary to reduce your company’s carbon footprint & leading on climate policy?</h4>
                                                        <div class="ml">
                                                            <div class="d-flex flex-column   justify-content-start">
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="checkbox" name="q2" id="q10_a">
                                                                        </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="checkbox" name="q2" id="q10_b">
                                                                        </div>
                                                                    <label>Setting science-based greenhouse gas reduction targets </label> 
                                                                </div>
        
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="checkbox" name="q2" id="q10_c">
                                                                        </div>
                                                                    <label>Collaborating across industries and supply chains  </label> 
                                                                </div>
        
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="checkbox" name="q2" id="q10_d">
                                                                        </div>
                                                                    <label>Adopting and deploying technologies to accelerate sustainability.  </label> 
                                                                </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="checkbox" name="q2" id="q10_f">
                                                                        </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="checkbox" name="q2" id="q10_g">
                                                                        </div>
                                                                ...
                                                                <div class="mr-2 d-flex justify-content-start">
                                                                    <div class="input_block">
                                                                        <input type="checkbox" name="q2" customatt="radio_option"
                                                                            id="q4_f" data-toggle="#q5_rank">
                                                                    </div>
                                                                    <!--label>Other (Specify) </label-->
                                                                    <input type="text" class="form-control  other_specify" id="other_spacity" placeholder="Other (Specify)" rows="1" style="width: 150px !important;
                                                    ...
                                                    <li>
                                                        <h4>How important is the role of the top management in “committing to and releasing a company-wide climate plan?</h4>
                                                        <div class="ml">
                                                            <div class="d-flex flex-xs-column flex-wrap   justify-content-start">
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                    ...
                                                    <li>
                                                        <h4>What efforts have your business taken to operate in ways that help protect the environment?</h4>
                                                     ...
                                                     <li>
                                                        <h4>How much has your company spent on investing in energy efficiency in the past year?</h4>
        
                                                        <div class="ml">
                                                            <div id="comment_14" aria-expanded="false" class="collapse show ">
                                                                <textarea class="form-control  openion_field" id="ans_3" rows="2"></textarea>
                                                            </div>
                                                        </div>
                                                      ...
                                                      <!--15th Question-->
                                                      <li>
                                                        <h4>What is the probability that your company over the medium to long-term will improve its environmental performance beyond the requirements established by existing regulations?</h4>
                                                        <div class="ml">
                                                            <div class="d-flex flex-xs-column flex-wrap   justify-content-start">
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                     ...
                                                     <li>
                                                        <h4>Why do you think companies continue to externalize climate change to other people, places and times?</h4>
        
                                                        <div class="ml">
                                                            <div class="d-flex flex-column justify-content-start toggle">
                                                                <div class="mr-2 d-flex  options ">
                                                                    <div class="input_block">
                                                                        <input type="checkbox" name="q16" customatt="radio_option"
                                                                            id="q16_a">
                                                                    </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    ...
                                                                    <label>Lack of regulations that penalize companies that fail</label>
                                                                </div>
                                                      ...
                                                      <!--17th Question-->
                                                      <li>
                                                        <h4>Voluntary environmental stewardship as a method of private governance </h4>
                                                        <div class="ml">
                                                            <div class="d-flex flex-column  justify-content-start">
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    ...
                                                                    <label>Not as effective as mandatory regulations for environmental protection  </label> 
                                                                </div>
                                                     ...
                                                     <!--18th Question-->
                                                     <li>
                                                        <h4>Has your company purchased carbon offsets or renewable energy certificates? </h4>
                                                        <div class="ml">
                                                            <div class="d-flex flex-xs-column flex-wrap   justify-content-start">
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                        ...
                                                        <!--19th Question-->
                                                        <li>
                                                        <h4>Cap-and-Trade Versus Carbon Tax, which works better & why? Please share your thoughts </h4>
                                                     ...
                                                     <li>
                                                        <h4>Carbon pricing programs adopted in countries worldwide are today fairly modest. How high do you think the prices should be to spur truly deep reductions in CO2?</h4>
        
                                                        <div class="ml">
                                                            <div class="d-flex flex-column justify-content-start toggle">
                                                                <div class="mr-2 d-flex  options ">
                                                                    <div class="input_block">
                                                                        <input type="radio" name="q20" customatt="radio_option"
                                                                            id="q20_a">
                                                                    </div>
                                                ...
                                                <!--19th Question-->
                                                <li>
                                                <h4>In your country what is the percentage (%) share of emissions covered by carbon pricing? </h4>
                                             ...
                                             <!---22th QUESTION-->
                                             <li>
                                                <h4>How confident are you about Joe Biden’s $2 trillion climate plan in achieving net zero by 2050? </h4>
                                              ...
                                              <!--23th Question-->
                                              <li>
                                                <h4>In accordance with U.S.’s renewed commitment to climate action, over 70% of businesses now need to set targets. Is your business ready for the implications posed by the American government’s climate leadership. </h4>
                                                <div class="ml">
                                                    <div class="d-flex flex-xs-column flex-wrap   justify-content-start">
                                                        <div class="mr-2 d-flex options">
                                                            <div class="input_block">
