                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="ml">
                                                            <div id="comment_12" aria-expanded="false" class="mt-1">
                                                                <textarea class="form-control  openion_field" id="comt_01"
                                                                    rows="2"></textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="ml mt-2 mb-4 target" id="q8_rank">
                                                            <div class="w-100 ">
                                                                <input type="text" class="form-control  w-100"
                                                                    ...
                                                                    style="width: 75px !important"></input>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="ml">
                                                            <div class="d-flex flex-column justify-content-start toggle">
                                                                <div class="mr-2 d-flex  options ">
                                                                    <div class="input_block">
                                                                        <input type="checkbox" name="q16"
                                                                            customatt="radio_option" id="q16_a">
                                                                    </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="checkbox" name="q16"
                                                                            customatt="radio_option" id="q16_b">
                                                                    </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="checkbox" name="q16"
                                                                            customatt="radio_option" id="q16_c">
                                                                    </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="checkbox" name="q16"
                                                                            customatt="radio_option" id="q16_d">
                                                                    </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="checkbox" name="q16"
                                                                            customatt="radio_option" id="q16_e">
                                                                    </div>
                                                                    <label>All of the above </label>
                                                                </div>
                                                                ...
                                                                <div class="mr-2 d-flex justify-content-start">
                                                                    ...
                                                                    <!--label>Other (Specify) </label-->
                                                                    <input type="text" class="form-control  other_specify other_spacify"
                                                                        id="other_spacity" placeholder="Other (Specify)"
                                                                        rows="1"></input>
                                                                </div>
