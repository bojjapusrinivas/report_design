                                ...
                                <div class="collapse show my-3 w-100 p-0" id="questionnaire">
                                    ...
                                    <div class=" border position-relitive" id="questionnaire_block">
                                        <div class="row text-primary  w-100 pb-2 mt-3 mb-0 text-center mt-0"
                                            ...
                                            <h1 class="font-weight-bold  line-height-normal" style="color: #E37038;"> CSR & EMPLOYEE MATCHING </h1>
                                            ...
                                            <form id="questioner">
                                                ...
                                                <ul class="question mt-2 mb-3">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="ml">
                                                            <div class="d-flex flex-wrap justify-content-start mb-1  border-bottom">
                                                            ...
                                                            <div class="d-flex flex-wrap justify-content-start mb-1 border-bottom">
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="radio" name="q1_1" customatt="radio_option"
                                                                            id="q1_a">
                                                                    </div>
                                                                    <label>Male </label>
                                                                </div>
                                                            ...
                                                            <div class="d-flex flex-wrap justify-content-start mb-1">
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="radio" name="q1_2" customatt="radio_option"
                                                                            id="q1_a">
                                                                    </div>
                                                                    <label>$150K </label>
                                                                </div>
                                                     ...
                                                     <!---2nd QUESTION-->
                                                     <li>
                                                        <h4>Environmental and social governance programs create shareholder value. Do you agree to this statement?</h4>
                                                        <div class="ml">
                                                    ...
                                                    <!---3nd QUESTION-->
                                                    <li>
                                                        <h4>As an investor, do you include CSR when evaluating investments in business projects or companies?</h4>
                                                        <div class="ml">
                                                     ...
                                                     <li>
                                                        <h4>What are the attributes of a company, as a modern consumer you find most important?</h4>
                                                     ...
                                                     <!---5nd QUESTION-->
                                                     <li>
                                                        <h4>How likely are you to buy an environment friendly product that is slightly more expensive than a conventional product?</h4>
                                                        <div class="ml">
        
                                                            <div class="d-flex flex-wrap justify-content-start ">
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="radio" name="q5" id="q2_a">
                                                                    </div>
                                                     ...
                                                     <!---6nd QUESTION-->
                                                     <li>
                                                        <h4>Do you believe that the current economic turmoil is decreasing the importance of environmental and social programs?</h4>
                                                        <div class="ml">
        
                                                            <div class="d-flex flex-wrap justify-content-start ">
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="radio" name="q6" id="q2_a">
                                                                    </div>
                                                                    <label>Yes </label>
                                                                </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    ...
                                                                    <div class="input_block">
                                                                        <input type="radio" name="q6" id="q2_b">
                                                                    </div>
                                                                    <label>No </label>
                                                                </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="radio" name="q6" id="q2_c">
                                                                    </div>
                                                                    <label>Don’t Know </label>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <!---7th QUESTION-->
                                                    <li>
                                                        <h4>Does your company have a CSR program in place? If yes are there tools to measure the value, effects or benchmark performance?</h4>
                                                            ...
                                                            <div class="w-100 ">
                                                                <div class="d-flex flex-column  justify-content-start">
                                                                    <div class="mr-2 d-flex options">
                                                                        ...
                                                                        <label>Regularly benchmark your business against others</label>
                                                                    </div>
            
                                                                    <div class="mr-2 d-flex options">
                                                                        <div class="input_block">
                                                                            <input type="radio" name="q7_1" id="q10_b">
                                                                        </div>
                                                                        <label>Use key performance indicators (KPIs) to measure your environmental performance </label>
                                                                    </div>
                                                                    ...
                                                                    <div class="mr-2 d-flex options">
                                                                        ...
                                                                        <label>Participate in CSR best practice shows & awards  </label>
                                                                    </div>
                                                                    <div class="mr-2 d-flex options">
                                                                        <div class="input_block">
                                                                            <input type="radio" name="q7_1" id="q10_c">
                                                                        </div>
                                                                        <label>Rely on external rating, ranking, or reporting standards or guidelines</label>
                                                                    </div>
                                                                    <div class="mr-2 d-flex justify-content-start">
                                                                        <div class="input_block">
                                                                            <input type="radio" name="q7_1" customatt="radio_option" id="q4_f" data-toggle="#q5_rank">
                                                                        </div>
                                                                        <!--label>Other (Specify) </label-->
                                                                        <input type="text" class="form-control  other_specify other_spacify" id="other_spacity" placeholder="Other (Specify)" rows="1">
                                                                    </div>
                                                     ...
                                                     <!---8nd QUESTION-->
                                                     <li>
                                                        <h4>Does your company have dedicated managers or ambassadors to promote your corporate philanthropy programs?</h4>
                                                        <div class="ml">
                                                    ...
                                                    <li>
                                                     ...
                                                     <li>
                                                        <h4>What value/benefits do CSR programs provide & how would you rank each of them?</h4>
                                                        ...
                                                        <div class="ml">
                                                            <div class="d-flex flex-column justify-content-start toggle">
                                                                <div class="mr-2 d-flex options">
                                                                    ...
                                                                    <label>Helps maintain a good corporate reputation and brand equity  </label>
                                                                </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    ...
                                                                    <label>Key role in attracting, motivating & retaining talented employees
                                                                    </label>
                                                                </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    ...
                                                                    <label>Improved access to capital in the stock market    </label>
                                                                </div>
                                                      ...
                                                      <li>
                                                        <h4>Which of the following activity in your opinion should be the most important part of CSR programs?</h4>
                                                        ...
                                                        <div class="ml">
                                                            <div class="d-flex flex-column justify-content-start toggle">
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    ...
                                                                    <label>Making long-term investments to address social issues  </label>
                                                                </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    ...
                                                                    <label>Create new revenue streams by developing new eco-friendly products  </label>
                                                                </div>
                                                     ...
                                                     <!---12th QUESTION-->
                                                     <li>
                                                        <h4>Do you think that that implementing a matching gifts program will improve the effectiveness of a company’s CSR program?</h4>
                                                     ...
                                                     <!---13th QUESTION-->
                                                     <li>
                                                        <h4>How is your company communicating CSR goals and benefits to employees, partners, shareholders, consumers/clients, suppliers, local communities, government and all other stakeholders?</h4>
                                                        ...
                                                        <div class="ml">
                                                            <div class="d-flex flex-column justify-content-start toggle">
                                                                <div class="mr-2 d-flex options">
                                                                    ...
                                                                    <label>Publishing CSR philosophy on corporate website  </label>
                                                                </div>
