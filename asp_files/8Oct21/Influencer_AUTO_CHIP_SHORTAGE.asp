                                    ...
                                    <div class=" border position-relitive" id="questionnaire_block">
                                        <div class="row text-primary  w-100 pb-2 mt-3 mb-0 text-center mt-0" id="questionnaire_title">
                                         ...
                                         <h3 class="d-block w-xl-95 w-lg-95 w-md-100 w-sm-100 w-100 mx-auto mt-0 mb-2 p-2 " style="font-style: italic; line-height: normal; font-size: 15px !important;">Privacy - Participants’ identities are never disclosed. Analyses by industry, rankings by company, and related trends and stats are published.
                                                               ...
                                                               <h4> How acute is the chip shortage faced by your company & how concerned are you? </h4>
                                                                ...
                                                                <div class="ml mt-2">
                                                                    <div id="comment_01" aria-expanded="false" class="collapse show ">
                                                                        <textarea class="form-control  comments_block" placeholder="Comments" id="ans_3" rows="2" placeholder="Comments"></textarea>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li>
                                                                ...
                                                                <div class="ml">
                                                                    <div class="d-flex flex-column justify-content-start toggle" >
                                                                        <div class="mr-2 d-flex options">
                                                                            <div class="input_block">
                                                                                <input type="checkbox" name="q7"  customatt="radio_option" id="q7_a" >
                                                                                </div>
                                                                        ...
                                                                        <div class="mr-2 d-flex options">
                                                                            <div class="input_block">
                                                                                <input type="checkbox" name="q7"   customatt="radio_option" id="q7_b" >
                                                                                </div>
                                                                        ...
                                                                        <div class="mr-2 d-flex options">
                                                                            <div class="input_block">
                                                                                <input type="checkbox" name="q7"   customatt="radio_option" id="q7_c"  >
                                                                                </div>
                                                                        ...
                                                                        <div class="mr-2 d-flex options">
                                                                            <div class="input_block">
                                                                                <input type="checkbox" name="q7"   customatt="radio_option" id="q7_d"  >
                                                                                </div>
                                                                        ...
                                                                        <div class="mr-2 d-flex options">
                                                                            <div class="input_block">
                                                                                <input type="checkbox" name="q7"   customatt="radio_option" id="q7_e"  >
                                                                                </div>
                                                            ...
                                                            <li>
                                                                ...
                                                                <div class="ml">
                                                                    <div class="d-flex flex-wrap justify-content-start toggle">
                                                                        <div class="mr-2 d-flex options">
                                                                            <div class="input_block">
                                                                                <input type="radio" name="q8"  customatt="radio_option" id="q8_a"  >
                                                                                </div>
                                                                            <label>Yes </label> 
                                                                        </div>
                                            ...
                                            <div class="ml mt-2">
                                                <div id="comment_01" aria-expanded="false" class="collapse show ">
                                                    <textarea class="form-control  comments_block" placeholder="Add Question " id="ans_3" rows="2" placeholder="Comments"></textarea>
                                                </div>
                                            </div>
                                                            ...
                                                            <li>
                                                                ...
                                                                <div class="ml">
                                                                    <div class="d-flex flex-wrap flex-column justify-content-start toggle">
                                                                        <div class="mr-2 d-flex options">
                                                                            <div class="input_block">
                                                                                <input type="checkbox" name="q10"  customatt="radio_option" id="q10_a" >
                                                                                </div>
                                                                        ...
                                                                        <div class="mr-2 d-flex options">
                                                                            <div class="input_block">
                                                                                <input type="checkbox" name="q10"   customatt="radio_option" id="q10_b"  >
                                                                                </div>
                                                                        ...
                                                                        <div class="mr-2 d-flex options">
                                                                            <div class="input_block">
                                                                                <input type="checkbox" name="q10"   customatt="radio_option" id="q10_c"  >
                                                                                </div>
                                                                        ...
                                                                        <div class="mr-2 d-flex options">
                                                                            <div class="input_block">
                                                                                <input type="checkbox" name="q10"  customatt="radio_option" id="q10_d" >
                                                                                </div>
                                                                        ...
                                                                        <div class="mr-2 d-flex justify-content-start">
                                                                            <div class="input_block">
                                                                                <input type="checkbox" name="q10" customatt="radio_option"
                                                                                    id="q4_f" data-toggle="#q5_rank">
                                                                            </div>
                                                                            <!--label>Other (Specify) </label--->
                                                                            <input type="text" class="form-control  other_specify" id="other_spacity" placeholder="Other (Specify)" rows="1" style="width: 150px !important;
                                                            ...
                                                            <li>
                                                             ...
                                                             <li>
                                                                <h4>Amid this shortage & rising raw material costs, auto stocks have underperformed. How has your company’s stock prices fared?</h4>
    
                                                                <div class="ml">
                                                                    <div class="d-flex flex-xl-row flex-lg-row flex-md-column flex-column justify-content-start toggle">
                                                                        <div class="mr-2 d-flex options">
                                                                            <div class="input_block">
                                                                                <input type="radio" name="q16"  customatt="radio_option" id="q16_a"  >
                                                                                </div>
                                                                            <label>Increase in Stock Prices </label> 
                                                                        </div>
    
                                                                        <div class="mr-2 d-flex options">
                                                                            <div class="input_block">
                                                                                <input type="radio" name="q16"  customatt="radio_option" id="q16_b"  >
                                                                                </div>
                                                                            <label>No Change in Stock Prices </label> 
                                                                        </div>
    
                                                                        <div class="mr-2 d-flex options">
                                                                            <div class="input_block">
                                                                                <input type="radio" name="q16"  customatt="radio_option" id="q16_c" >
                                                                                </div>
                                                                            <label>Decrease in Stock Prices  </label> 
                                                                        </div>
    
                                                                        <div class="mr-2 d-flex options">
                                                                            <div class="input_block">
                                                                                <input type="radio" name="q16"  customatt="radio_option" id="q16_d" >
                                                                                </div>
                                                                            <label>Don’t Know  </label> 
                                                                        </div>
                                                                    </div>
