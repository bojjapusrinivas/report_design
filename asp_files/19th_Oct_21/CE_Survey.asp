...
================================================== -->
<meta charset="utf-8">
<title>US Auto Clean Energy Policy - Validated Employee Survey - StrategyR.com</title>
                                ...
                                <div class="show  my-0 w-100 p-0" id="survey_template">
                                    ...
                                    <div class="position-relitive">
                                            <div class="row text-primary  w-100 pb-0 mb-0 text-center mt-0" id="survey_title">
                                                    <h2 class="mt-0 px-3 p-0">US AUTO CLEAN ENERGY POLICY</h2>
                                            ...
                                            <div class="mt-2 w-100">
                                                ...
                                                <div class="row mb-2 w-lg-85 w-xl-85 w-md-100 w-sm-100 w-100 mx-auto">
                                                    ...
                                                    <div class="row mb-2 w-lg-85 w-xl-85 w-md-100 w-sm-100 w-100 mx-auto">
                                                        ...
                                                        <p class="  mb-2">
                                                            With climate change dominating Joe Biden's agenda, the U.S. is emerging into the global forefront for tacking environmental issues. What’s coming next is a period of change for the domestic automotive industry. Opportunities and challenges abound in equal measure for the entire ecosystem of players in this industry. The series of landmark decisions taken, from phasing out gas cars, boosting sales of green cars to over half of 2030 sales to tightening emission and fuel efficiency standards (CAFE), are poised to have multifarious impact on auto OEMs and the supplier partners. Do American automakers and the Joe Biden government share the vision for clean transportation? Will R&D costs for producing cleaner fossil fuel vehicles increase? Will more resources be diverted to developing and producing alternate vehicles?  Will traditional automakers make the portfolio shift from conventional cars to EVs? How will manufacturing dynamics change post implementation of automotive clean energy policy? Are U.S.EV policies adequate? What do Americans really think about EVs & their touted game changer roles? Is e-mobility the only future or will biodiesel also co-exist in this grand scheme for clean and green transportation?  Your responses will help us find out. 
            
                                                        </p>
                                                        <p class="  mb-2">GIA’s Executive Insights Campaign evokes creative solutions to complex problems and presents solutions through a dynamic virtual community of domain experts. The survey program is designed to understand the potential impact of new clean energy policies legislated by the Joe Biden government on the U.S. auto industry.  The survey is designed to help all participants, companies and industry stakeholders know what to expect and prepare for the coming challenges and opportunities during this clean energy transition of epic proportions never before seen in America’s history.  </p>
                                                        ...
                                                        <ul class="forteen columns text-left gia_list_display mb-0 ml-3">
                                                            <li>Self report your experiences, self-assess your knowledge about clean energy policies and share objective information and subjective views and opinions in the context of US Auto Clean Energy Policy. Participating in the survey will help you reflect on your experience to see patterns and opportunities for learning you may have missed.  </li>
                                                            ...
                                                            <li>Find out everything you ever wanted to know about how auto clean energy policies will shape the evolution of the auto industry over the coming decade.
                                                            </li>
                                                            <li> View & track all influencers in this space.
                                                            </li>
                                                ...
                                                <div class="row mb-0">
													...
													<div class="row">                                                    
                                                            <div class="w-100 ">
																...
																<%if session("EID") <>"" then%>
																<a href="https://www.strategyr.com/Influencer_AUTO_CLEAN_ENERGY_POLICY.asp" style="color:#fff!important; font-weight:600" class="rounded-0    btn_type_03 "  type="submit"  name="btnsubmit" value="OK"  >SURVEY</a>
																<%else%>
																...
																<a href="https://www.strategyr.com/market-report-US-auto-clean-energy-policy-forecasts-global-industry-analysts-inc.asp" style="color:#fff!important; font-weight:600;" class="rounded-0     btn_type_03 "  type="submit"  name="btnsubmit" value="OK" style="background: #23B14D !important;"  >REPORT</a>
