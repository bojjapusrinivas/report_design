...
================================================== -->
<meta charset="utf-8">
<title>Cybersecurity  - Validated Employee Survey - StrategyR.com</title>
<meta name="description" content="Cybersecurity - Validated Employee Survey"/>
                                ...
                                <div class="show  my-0 w-100 p-0" id="survey_template">
                                    ...
                                    <div class="position-relitive">
                                            <div class="row text-primary  w-100 pb-0 mb-0 text-center mt-0" id="survey_title">
                                                    <h2 class="mt-0 px-3 p-0">Cybersecurity</h2>
                                            ...
                                            <div class="mt-2 w-100">
                                                ...
                                                <div class="row mb-2 w-lg-85 w-xl-85 w-md-100 w-sm-100 w-100 mx-auto">
                                                    ...
                                                    <p class="  mb-2">
                                                        As the world relies more on digital technologies, products and services, cybersecurity will continue to remain important for companies, governments, people and the economy as a whole. Security risks continue to morph and change, making it important to continuously lay the groundwork to prepare for future attacks on IT infrastructures. With digitalization and digital transformation catalyzed by the COVID-19 pandemic, cybersecurity has gathered even more significance. The pandemic has more than tripled the value of digital assets so much so that robust cybersecurity measures have emerged to become a leading indicator of business success. The virtual assets industry is at the crucial juncture with cybersecurity threats at an all-time high and companies, people and the economy has a whole having more to lose than ever before. Are companies aware of how much they stand to lose in case of a security compromise? Are they aware of the gaps in their preparedness? How many have imbibed basic cybersecurity hygiene in their everyday activity? Are companies assessing their cyber hygiene on a periodic basis? How much do companies lose in cyber-attacks each year?  How many companies actually believe that cyber risk management must be owned at board level rather than by the IT department? What ideologies lead to success or failure of cybersecurity strategies?  Your responses will help us find out.
        
                                                    </p>
                                                    <p class="  mb-2">GIA’s Executive Insights Campaign evokes creative solutions to complex problems and presents solutions through a dynamic virtual community of domain experts. The survey program is designed to understand the evolving landscape of cybersecurity and how companies are, can and should be preparing for this challenge. By capturing expert opinions and perceptions on the topic, the survey provides an opportunity for companies to retrospect on their security strategies and plan ahead on catching up in this cat and mouse game.   </p>
                                                    ...
                                                    <ul class="forteen columns text-left gia_list_display mb-0 ml-3">
                                                        <li>Self report your experiences; retrospect on your strategies, their success and failures; self-assess your knowledge on the subject and share objective information and subjective views and opinions in the context of Cybersecurity. Participating in the survey will help you review and reflect on your experience to see patterns and opportunities for learning you may have missed. </li>
        
                                                        <li>Access our survey report and discover new curated insights shared by corporate leaders & domain experts and use them to shape your decisions.</li>
                                                        <li>Find out everything you ever wanted to know about cybersecurity and how to strengthen your security posture.
                                                        </li>
                                                ...
                                                <div class="row mb-0">
													...
													<div class="row">                                                    
                                                            <div class="w-100 ">
																...
																<%if session("EID") <>"" then%>
																<a href="https://www.strategyr.com/Influencer_Cybersecurity.asp" style="color:#fff!important; font-weight:600" class="rounded-0    btn_type_03 "  type="submit"  name="btnsubmit" value="OK"  >SURVEY</a>
																<%else%>
																...
																<%if session("EID") <>"" then%>
																<a href="https://www.strategyr.com/Survey_Influencers.asp?stype=Cybersecurity" style="color:#fff!important; font-weight:600" class="rounded-0     btn_type_03 " type="submit"  name="btnsubmit" value="OK"  >INFLUENCERS</a>
																<%else%>
																...
																<a href="https://www.strategyr.com/market-report-cybersecurity-forecasts-global-industry-analysts-inc.asp" style="color:#fff!important; font-weight:600;" class="rounded-0     btn_type_03 "  type="submit"  name="btnsubmit" value="OK" style="background: #23B14D !important;"  >REPORT</a>
