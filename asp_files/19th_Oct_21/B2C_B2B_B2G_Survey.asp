                                ...
                                <div class="show  my-0 w-100 p-0" id="survey_template">
                                    ...
                                    <div class="position-relitive">
                                            <div class="row text-primary  w-100 pb-0 mb-0 text-center mt-0" id="survey_title">
                                                    <h2 class="mt-0 px-3 p-0">B2C - B2B - B2G</h2>
                                            ...
                                            <div class="mt-2 w-100">
                                                ...
                                                <div class="row mb-2 w-lg-85 w-xl-85 w-md-100 w-sm-100 w-100 mx-auto">
                                                    ...
                                                    <p class="  mb-2">
                                                        The advent of the Internet has led to business models changing. Even today businesses are continuing to evolve in the way they sell to their customers and the way customers buy from them. As organizations reshape into more virtual entities, a growing proportion of businesses of evolving into B2C, B2B, & B2G, C2C, C2B, G2B & G2C, B2G & C2G and B2B2C.  Interestingly, our research shows that unlike popularly believed, transformation is not about adopting and deploying new technologies. Rather, it is all about linking a new technology to an emerging market need, which can be achieved only via an agile business model. A business model is therefore the key to transformation. How can companies tell if their business models are transformative? What are the dynamics of a B2B, B2C, or C2C marketplace? How are B2B, B2C, or C2C companies reaching new customers? How many companies really understand their eCommerce business model? What does it take to apply the right eCommerce business model? Your responses will help us find out.
        
                                                    </p>
                                                    <p class="  mb-2">GIA’s Executive Insights Campaign evokes creative solutions to complex problems and presents solutions through a dynamic virtual community of domain experts. The survey program is designed to understand the evolving landscape of B2C - B2B - B2G types of e-Commerce business models. The survey acts a guide for start -ups planning to build their B2B, B2C, or C2C marketplace.   </p>
                                                    ...
                                                    <ul class="forteen columns text-left gia_list_display mb-0 ml-3">
                                                        <li>Self report your experiences; retrospect on your strategies, their success and failures; self-assess your knowledge on the subject and share objective information and subjective views and opinions in the context of B2C - B2B - B2G business models. Participating in the survey will help you review and reflect on your experience to see patterns and opportunities for learning you may have missed.   </li>
                                                        ...
                                                        <li>Find out everything you ever wanted to know about attracting vendors and customers under the B2C - B2B - B2G business models.  
                                                        </li>
