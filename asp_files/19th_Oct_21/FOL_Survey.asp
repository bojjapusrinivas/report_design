                                            ...
                                            <div class="mt-2 w-100">
                                                ...
                                                <div class="row mb-2 w-lg-85 w-xl-85 w-md-100 w-sm-100 w-100 mx-auto">
                                                    ...
                                                    <ul class="forteen columns text-left gia_list_display mb-0 ml-3">
                                                        <li>Self report your experiences; retrospect on your strategies, their success and failures; self-assess your knowledge on the subject and share objective information and subjective views and opinions in the context of the Future of Learning & Education. Participating in the survey will help you review and reflect on your experience to see patterns and opportunities for learning you may have missed. </li>
                                                        ...
                                                        <li>Find out how demographics and technology are influencing learning and what the younger generation really need from education and how educational institutions can and should adapt. 
                                                        </li>
                                                ...
                                                <div class="row mb-0">
													...
													<div class="row">                                                    
                                                            <div class="w-100 ">
																...
																<%if session("EID") <>"" then%>
																<a href="https://www.strategyr.com/Influencer_FUTURE_OF_LEARNING_EDUCATION.asp" style="color:#fff!important; font-weight:600" class="rounded-0    btn_type_03 "  type="submit"  name="btnsubmit" value="OK"  >SURVEY</a>
																<%else%>
																...
																<a href="https://www.strategyr.com/market-report-future-of-learning-education-forecasts-global-industry-analysts-inc.asp" style="color:#fff!important; font-weight:600;" class="rounded-0     btn_type_03 "  type="submit"  name="btnsubmit" value="OK" style="background: #23B14D !important;"  >REPORT</a>
