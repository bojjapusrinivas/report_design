                                ...
                                <div class="show  my-0 w-100 p-0" id="survey_template">
                                    ...
                                    <div class="position-relitive">
                                            <div class="row text-primary  w-100 pb-0 mb-0 text-center mt-0" id="survey_title">
                                                    <h2 class="mt-0 px-3 p-0">DIVERSITY, EQUITY & INCLUSION</h2>
                                            ...
                                            <div class="mt-2 w-100">
                                                ...
                                                <div class="row mb-2 w-lg-85 w-xl-85 w-md-100 w-sm-100 w-100 mx-auto">
                                                    ...
                                                    <p class="  mb-2">
                                                        The benefits of DEI and its importance as a critical business strategy are well acknowledged and companies are already down their own unique path to create a diverse and inclusive workplace. Whether the journey has just begun or half completed or well on its way to achieving targeted goals, our research shows that there is always plenty more to be done. A whopping 90% of companies struggle to maintain unswerving focus on DEI commitments and adapt their DEI efforts to the reality of the crisis. Why is DEI so hard to achieve in the workplace? What ails its successful implementation?  What measures companies take to create an inclusive work environment and how can it be done better? How many companies are actually successful in achieving DEI goals and why? DEI, do companies just see it as rules in a book or a commitment to deal with a multifaceted workforce? Should the HR department be at the top of this game? How many employees in a company actually support its DEI program?  Your responses will help us find out.
        
                                                    </p>
                                                    <p class="  mb-2">GIA’s Executive Insights Campaign evokes creative solutions to complex problems and presents solutions through a dynamic virtual community of domain experts. The survey program is designed to help companies measure and understand how people feel about their workplace. By measuring and capturing a granular view of employees’ real DEI experience, the insights from the survey will make it easier to take action to create more inclusive workplaces.  </p>
                                                    ...
                                                    <ul class="forteen columns text-left gia_list_display mb-0 ml-3">
                                                        <li>Self report your goals, objectives, experiences and share objective information and subjective views and opinions in the context of DEI in the workplace. Participating in the survey will help you reflect on your experience, to see patterns and opportunities for learning you may have missed.  </li>
                                                        ...
                                                        <li>Understand the impact of DEI programs on employee experience & be inspired to take powerful action to make corporate life more inclusive and equal for all.  
                                                        </li>
                                                ...
                                                <div class="row mb-0">
													...
													<div class="row">                                                    
                                                            <div class="w-100 ">
																...
																<%if session("EID") <>"" then%>
																<a href="DIVERSITY_INCLUSION_QUESTIONNAIRE.asp" style="color:#fff!important; font-weight:600" class="rounded-0    btn_type_03 "  type="submit"  name="btnsubmit" value="OK"  >SURVEY</a>
																<%else%>
																...
																<%if session("EID") <>"" then%>
																<a href="https://www.strategyr.com/Survey_Influencers.asp?stype=Diversity" style="color:#fff!important; font-weight:600" class="rounded-0     btn_type_03 " type="submit"  name="btnsubmit" value="OK"  >INFLUENCERS</a>
																<%else%>
																...
																<a href="https://www.strategyr.com/market-report-diversity-and-inclusion-forecasts-global-industry-analysts-inc.asp" style="color:#fff!important; font-weight:600;" class="rounded-0     btn_type_03 "  type="submit"  name="btnsubmit" value="OK" style="background: #23B14D !important;"  >REPORT</a>
