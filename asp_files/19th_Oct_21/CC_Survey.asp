...
================================================== -->
<meta charset="utf-8">
<title>Cryptocurrency - Validated Employee Survey - StrategyR.com</title>
<meta name="description" content="Cryptocurrency- Validated Employee Survey"/>
                                ...
                                <div class="show  my-0 w-100 p-0" id="survey_template">
                                    ...
                                    <div class="position-relitive">
                                            <div class="row text-primary  w-100 pb-0 mb-0 text-center mt-0" id="survey_title">
                                                    <h2 class="mt-0 px-3 p-0">Cryptocurrency</h2>
                                            ...
                                            <div class="mt-2 w-100">
                                                ...
                                                <div class="row mb-2 w-lg-85 w-xl-85 w-md-100 w-sm-100 w-100 mx-auto">
                                                    ...
                                                    <p class="  mb-2">
                                                        Digital disruption is everywhere including in the “Money” market. Money which for centuries has been the medium of exchange all around the world, managed and controlled by governments. Cryptocurrency has disrupted banking and finance in ways unimagined.  As a financial investment, cryptocurrencies have been hyped and condemned in equal measure. While speculators have queued up to partake in virtual currencies with intense fervor, professional investors have been kept at bay by volatilities in price and value.  The fact that crypto assets are growing cannot be denied any more than the fact that cryptocurrencies have been gaining wider distribution over the last couple of years, benefitting largely from the popularity of Bitcoin. Why governments are wary and threatened by cryptocurrency to the point that they feel the need to assert sovereignty by enforcing regulations and introducing their own digital cash? Can cryptocurrency really become the future of money? What interest does an average investor have in cryptocurrency? Can cryptocurrency make money laundering easy? Do cryptocurrency have the potential to enable social and economic growth?  What’s the technology’s environmental impact? Your responses will help us find out. 
        
                                                    </p>
                                                    <p class="  mb-2">GIA’s Executive Insights Campaign evokes creative solutions to complex problems and presents solutions through a dynamic virtual community of domain experts. The survey program is designed to understand the evolving concept on cryptocurrency and its impact on the money market by capturing expert opinions and perceptions on the value and benefits of the technology along with its pitfalls. The survey acts as a guide to comprehend virtual currencies before making an investment decision.      </p>
                                                    ...
                                                    <ul class="forteen columns text-left gia_list_display mb-0 ml-3">
                                                        <li>	Self report your experiences, self-assess your knowledge about the technology and share objective information and subjective views and opinions in the context of Cryptocurrency. Participating in the survey will help you reflect on your experience to see patterns and opportunities for learning you may have missed.  </li>
                                                        ...
                                                        <li>	Find out everything you ever wanted to know about cryptocurrency.
                                                        </li>
                                                ...
                                                <div class="row mb-0">
													...
													<div class="row">                                                    
                                                            <div class="w-100 ">
																...
																<%if session("EID") <>"" then%>
																<a href="https://www.strategyr.com/Influencer_CRYPTOCURRENCY_TRENDS.asp" style="color:#fff!important; font-weight:600" class="rounded-0    btn_type_03 "  type="submit"  name="btnsubmit" value="OK"  >SURVEY</a>
																<%else%>
																...
																<a href="https://www.strategyr.com/market-report-cryptocurrency-forecasts-global-industry-analysts-inc.asp" style="color:#fff!important; font-weight:600;" class="rounded-0     btn_type_03 "  type="submit"  name="btnsubmit" value="OK" style="background: #23B14D !important;"  >REPORT</a>
