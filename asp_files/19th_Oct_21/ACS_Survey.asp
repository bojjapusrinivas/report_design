...
================================================== -->
<meta charset="utf-8">
<title>ACS - AUTO CHIP SHORTAGE - Validated Employee Survey - StrategyR.com</title>
<meta name="description" content="ACS - AUTO CHIP SHORTAGE - Validated Employee Survey  - Validated Employee Survey"/>
                                ...
                                <div class="show  my-0 w-100 p-0" id="survey_template">
                                    ...
                                    <div class="position-relitive">
                                            <div class="row text-primary  w-100 pb-0 mb-0 text-center mt-0" id="survey_title">
                                                    <h2 class="mt-0 px-3 p-0">AUTO CHIP SHORTAGE</h2>
                                            ...
                                            <div class="mt-2 w-100">
                                                ...
                                                <div class="row mb-2 w-lg-85 w-xl-85 w-md-100 w-sm-100 w-100 mx-auto">
                                                    ...
                                                    <p class="  mb-2">
                                                        In a world where technology is becoming omnipresent and advanced semiconductor chips lurk behind the smartest computers to the humble toothbrush, the ongoing chip shortage is sending shockwaves through the global economy. Production and supplies of all digital products from the simple headphones to feature rich cars is today squeezed, resulting in rising prices. This technology inflation comes as a big blow to digital transformation accelerated into motion by the pandemic. The automotive industry stands among the worst hit, faced with the now all too imminent reversal of recovering growth. How are automakers responding to the crisis? How have they been impacted? How did the crisis emerge and who and what’s responsible for the same? How did the world get blindsided on this very essential semiconductor component?   How are auto OEMs now re-thinking their electronic component supply chain strategies to build resilience? How long will the crisis last? What can be learned from the crisis? Your responses will help us find out.   
        
                                                    </p>
                                                    <p class="  mb-2">GIA’s Executive Insights Campaign evokes creative solutions to complex problems and presents solutions through a dynamic virtual community of domain experts. The goal of the survey program is to understand the workings of this great supply shock, gauge current levels of visibility into the Tier 1 supply base, assess the impact on manufacturing competitiveness, and find out how automakers and suppliers are navigating these turbulent times.  By capturing expert opinions and perceptions on this nearly universal concern, the survey seeks to shed additional light on the issue.  </p>
                                                    ...
                                                    <ul class="forteen columns text-left gia_list_display mb-0 ml-3">
                                                        <li>Self report your experiences; retrospect on your strategies, their success and failures; self-assess your knowledge on the subject and share objective information and subjective views and opinions in the context of the ongoing automotive chip shortage crisis. Participating in the survey will help you review and reflect on your experience to see patterns and opportunities for learning you may have missed.  </li>
                                                        ...
                                                        <li>Find out how the crisis is panning out for the automotive industry.  
                                                        </li>
                                                        <li> Learn new ways to adapt and brace for an extended chip shortage.</li>
                                                ...
                                                <div class="row mb-0">
													...
													<div class="row">                                                    
                                                            <div class="w-100 ">
																...
																<%if session("EID") <>"" then%>
																<a href="https://www.strategyr.com/Influencer_AUTO_CHIP_SHORTAGE.asp" style="color:#fff!important; font-weight:600" class="rounded-0    btn_type_03 "  type="submit"  name="btnsubmit" value="OK"  >SURVEY</a>
																<%else%>
																...
																<%if session("EID") <>"" then%>
																<a href="https://www.strategyr.com/Survey_Influencers.asp?stype=Automotive" style="color:#fff!important; font-weight:600" class="rounded-0     btn_type_03 " type="submit"  name="btnsubmit" value="OK"  >INFLUENCERS</a>
																<%else%>
																...
																<a href="https://www.strategyr.com/ecosystemsInsider.asp?ind=AUTO&Pageview=Show" style="color:#fff!important; font-weight:600;" class="rounded-0     btn_type_03 "  type="submit"  name="btnsubmit" value="OK"   >REPORT</a>
