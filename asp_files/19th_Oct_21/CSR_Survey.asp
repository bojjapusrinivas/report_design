...
================================================== -->
<meta charset="utf-8">
<title>CSR - CORPORATE SOCIAL RESPONSIBILITY - Validated Employee Survey - StrategyR.com</title>
                                ...
                                <div class="show  my-0 w-100 p-0" id="survey_template">
                                    ...
                                    <div class="position-relitive">
                                            <div class="row text-primary  w-100 pb-0 mb-0 text-center mt-0" id="survey_title">
                                                    <h2 class="mt-0 px-3 p-0">CORPORATE SOCIAL RESPONSIBILITY</h2>
                                            ...
                                            <div class="row mb-2 w-lg-85 w-xl-85 w-md-100 w-sm-100 w-100 mx-auto">
                                                ...
                                                <p class="  mb-2">
                                                    Corporate social responsibility (CSR) programs not only make businesses stronger by building reputation but also make the world a better place to live in. Our research shows that people (consumers & the community) expect more from the corporate sector. Over 58% of people express low confidence in domestic and global companies. The business case for CSR is therefore uncontested and companies need to make corporate citizenship a priority to reduce the risk of business disruptions, open up new opportunities, drive innovation, enhance brand value and company reputation and boost revenues. How many companies know what consumers and stakeholders expect from them? How many companies really know if their CSR program is actually bolstering their reputation and differentiating their brand? How much budget is being allocated for acquiring technology tools for CSR? Are CSR programs being tied to business objectives? How many companies are evolving and adapting the program on a continuous basis? How many are even listening to feedback from stakeholders & consumers? Your responses will help us find out.
        
                                                </p>
                                                <p class="  mb-2">GIA’s Executive Insights Campaign evokes creative solutions to complex problems and presents solutions through a dynamic virtual community of domain experts. The survey program is designed to help companies establish their baseline and long-term CSR vision and measure and understand the effectiveness of current initiatives. By capturing opinions and factors that influence perceptions and attitudes of employees and people towards CSR, the survey can act as a guide to simplify implementation decisions, better manage future activities and stay connected with CSR objectives, initiatives and programs.</p>
                                                ...
                                                <ul class="forteen columns text-left gia_list_display mb-0 ml-3">
                                                    <li>Self report your goals, objectives, experiences and share objective information and subjective views and opinions in the context of CSR & Employee Matching. Participating in the survey will help you reflect on your experience to see patterns and opportunities for learning you may have missed.  </li>
                                                    ...
                                                    <li>Understand how CSR affects individuals, community, the economy and the environment. </li>
                                                    <li>Be inspired to take powerful action to align your company’s CSR initiatives with employee, consumer, social and environmental wellness goals.</li>
                                                ...
                                                <div class="row mb-0">
													...
													<div class="row">                                                    
                                                            <div class="w-100 ">
																...
																<%if session("EID") <>"" then%>
																<a href="Influencer_CSR_EMPLOYEE_MATCHING.asp" style="color:#fff!important; font-weight:600" class="rounded-0    btn_type_03 "  type="submit"  name="btnsubmit" value="OK"  >SURVEY</a>
																<%else%>
																...
																<%if session("EID") <>"" then%>
																<a href="https://www.strategyr.com/Survey_Influencers.asp?stype=Corporate social responsibility" style="color:#fff!important; font-weight:600" class="rounded-0     btn_type_03 " type="submit"  name="btnsubmit" value="OK"  >INFLUENCERS</a>
																<%else%>
																...
																<a href="https://www.strategyr.com/market-report-corporate-social-responsibility-CSR-employee-matching-forecasts-global-industry-analysts-inc.asp" style="color:#fff!important; font-weight:600;" class="rounded-0     btn_type_03 "  type="submit"  name="btnsubmit" value="OK"   >REPORT</a>
