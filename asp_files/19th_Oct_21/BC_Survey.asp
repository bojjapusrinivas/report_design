...
================================================== -->
<meta charset="utf-8">
<title>Blockchain - Validated Employee Survey - StrategyR.com</title>
<meta name="description" content="Blockchain- Validated Employee Survey"/>
                                ...
                                <div class="show  my-0 w-100 p-0" id="survey_template">
                                    ...
                                    <div class="position-relitive">
                                            <div class="row text-primary  w-100 pb-0 mb-0 text-center mt-0" id="survey_title">
                                                    <h2 class="mt-0 px-3 p-0">Blockchain</h2>
                                            ...
                                            <div class="mt-2 w-100">
                                                ...
                                                <div class="row mb-2 w-lg-85 w-xl-85 w-md-100 w-sm-100 w-100 mx-auto">
                                                    ...
                                                    <ul class="forteen columns text-left gia_list_display mb-0 ml-3">
                                                        <li>Self report your experiences; retrospect on your strategies, their success and failures; self-assess your knowledge on the subject and share objective information and subjective views and opinions in the context of Blockchain. Participating in the survey will help you review and reflect on your experience to see patterns and opportunities for learning you may have missed. </li>
                                                        ...
                                                        <li>Find out how blockchain can reshape your industry/market and what should be your long-term objectives and strategies.
                                                        </li>
                                                        <li>Be inspired to leverage this technology to create new market ecosystems.</li>
                                                ...
                                                <div class="row mb-0">
													...
													<div class="row">                                                    
                                                            <div class="w-100 ">
																...
																<%if session("EID") <>"" then%>
																<a href="https://www.strategyr.com/Influencer_BLOCKCHAIN_INDUSTRY_ADOPTION.asp" style="color:#fff!important; font-weight:600" class="rounded-0    btn_type_03 "  type="submit"  name="btnsubmit" value="OK"  >SURVEY</a>
																<%else%>
																...
																<%if session("EID") <>"" then%>
																<a href="https://www.strategyr.com/Survey_Influencers.asp?stype=blockchain" style="color:#fff!important; font-weight:600" class="rounded-0     btn_type_03 " type="submit"  name="btnsubmit" value="OK"  >INFLUENCERS</a>
																<%else%>
																...
																<a href="https://www.strategyr.com/market-report-blockchain-forecasts-global-industry-analysts-inc.asp" style="color:#fff!important; font-weight:600;" class="rounded-0     btn_type_03 "  type="submit"  name="btnsubmit" value="OK" style="background: #23B14D !important;"  >REPORT</a>
