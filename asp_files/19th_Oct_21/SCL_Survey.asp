...
================================================== -->
<meta charset="utf-8">
<title>Supply Chain & Logistics - Validated Employee Survey - StrategyR.com</title>
                                ...
                                <div class="show  my-0 w-100 p-0" id="survey_template">
                                    ...
                                    <div class="position-relitive">
                                            <div class="row text-primary  w-100 pb-0 mb-0 text-center mt-0" id="survey_title">
                                                    <h2 class="mt-0 px-3 p-0">SUPPLY CHAIN AND LOGISTICS</h2>
                                            ...
                                            <div class="mt-2 w-100">
                                                ...
                                                <div class="row mb-2 w-lg-85 w-xl-85 w-md-100 w-sm-100 w-100 mx-auto">
                                                    ...
                                                    <p class="  mb-2">
                                                        A perfect storm of change has plunged global supply chains into a state of massive flux. Hitherto engineered to manage stable and high-volume production, supply chains today are being recalibrated to exhibit resilience to global uncertainty, business complexity, turbulent trade and capital flows, and disruptions in demand and supply. It is no secret that companies best managing their supply chains for growing uncertainty and complexity will emerge successful in staying ahead of competition. It is time to move from a one-size-fits-all to a differentiated supply chain management approach. New wisdom dictates that “splintering” traditional supply chains into smaller, nimbler ones will help significantly in managing higher levels of complexity. How easy is this to achieve for companies?  What does it take to simplify supply chains?  What benefits do companies expect from their supply chain investments?  Are companies shifting away from Just-in-Time inventory strategy to ensure resilient supply chains? What supply chain technologies are being deployed by companies? Which technology has reported the highest ROI? Your responses will help us find out. 
        
                                                    </p>
                                                    <p class="  mb-2">GIA’s Executive Insights Campaign evokes creative solutions to complex problems and presents solutions through a dynamic virtual community of domain experts. The survey program is designed to understand how companies and industry leaders are preparing today for tomorrow’s challenges. The survey acts as a perspective builder for all participants and companies hoping to get more from their supply chains in the coming years.  </p>
                                                    ...
                                                    <ul class="forteen columns text-left gia_list_display mb-0 ml-3">
                                                        <li>Self report your experiences, self-assess your knowledge about the technology and share objective information and subjective views and opinions in the context of Supply Chains & Logistics. Participating in the survey will help you reflect on your experience to see patterns and opportunities for learning you may have missed.  </li>
                                                        ...
                                                        <li>Find out everything you ever wanted to know about trends having knock-on effects on supply chains and how to meet the challenge of change and transformation.  
                                                        </li>
                                                ...
                                                <div class="row mb-0">
													...
													<div class="row">                                                    
                                                            <div class="w-100 ">
																...
																<%if session("EID") <>"" then%>
																<a href="https://www.strategyr.com/Influencer_SUPPLY_CHAIN_LOGISTICS.asp" style="color:#fff!important; font-weight:600" class="rounded-0    btn_type_03 "  type="submit"  name="btnsubmit" value="OK"  >SURVEY</a>
																<%else%>
																...
																<a href="https://www.strategyr.com/market-report-supply-chain-logistics-forecasts-global-industry-analysts-inc.asp" style="color:#fff!important; font-weight:600;" class="rounded-0     btn_type_03 "  type="submit"  name="btnsubmit" value="OK" style="background: #23B14D !important;"  >REPORT</a>
