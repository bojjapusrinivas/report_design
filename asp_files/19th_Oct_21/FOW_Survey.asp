...
================================================== -->
    <meta charset="utf-8">
    <title>FUTURE OF WORK - Validated Employee Survey - StrategyR.com</title>
                            ...
                            <div class="show  my-0 w-100 p-0" id="survey_template">
                                ...
                                <div class="position-relitive">
                                    <div class="row text-primary  w-100 pb-0 mb-0 text-center mt-0" id="survey_title">
                                        <h2 class="mt-0 px-3 p-0">FUTURE OF WORK</h2>
                                    ...
                                    <div class="mt-2 w-100">
                                        ...
                                        <div class="row mb-2 w-lg-85 w-xl-85 w-md-100 w-sm-100 w-100 mx-auto">
                                            ...
                                            <p class="  mb-2">
                                                The importance of agility and adaptability can never be over-emphasized in the corporate world. Workplace dynamics is transitioning at a scale and pace that makes it imperative for companies to demonstrate more sensitivity. After all, employees are the building blocks for success in any company. With the COVID-19 pandemic heaping monumental challenges on the front lines of the workplace, it is time to get practical about the future of work. Over 52% of employees express discontent over their work arrangement and scheduling. Now is the time for companies to make workforce transitions a more urgent priority. How many companies are actually ready to take on the future of work? How many companies are amending their work policies and what are the key considerations?  How is work continuously reinvented in a company? Do companies provide frictionless access to reskilling opportunities? How sensitive are companies to employees’ work needs?  Do companies see a future in other different work arrangements beyond regular traditional employment? What employees really feel about their work arrangement?  Your responses will help us find out.

                                            </p>
                                            <p class="  mb-2">GIA’s Executive Insights Campaign evokes creative solutions to complex problems and presents solutions through a dynamic virtual community of domain experts. The survey program is designed to understand possible “Worlds of Work” scenarios evolving through 2030 to help companies’ kick-start their thinking, understand the future and be prepared for it. By capturing what people want and expect from their jobs, the survey can share knowledge and insights that can help companies change business processes to drive deeper employee engagement, keep employees happy and in doing so help their businesses thrive.    </p>
                                            ...
                                            <ul class="forteen columns text-left gia_list_display mb-0 ml-3">
                                                <li>Self report your goals, objectives, experiences and share objective information and subjective views and opinions in the context of Future of Work. Participating in the survey will help you reflect on your experience to see patterns and opportunities for learning you may have missed. </li>
                                                ...
                                                <li>Find out what causes turnover, disengagement and frustration among your employees and be inspired to successfully execute your plans, to figure out your hybrid work model, make processes & operational changes, revamp old school ideologies of work and, most importantly, attract and retain top talent.
                                                </li>
                                                <li>Find out what causes turnover, disengagement and frustration among your employees and be inspired to successfully execute your plans, to figure out your hybrid work model, what may work for you and what may not, make processes & operational changes, revamp old school ideologies of work and, most importantly, attract and retain top talent.</li>
                                        ...
                                        <div class="row">
                                            <div class="w-100 ">
                                                ...
                                                <span
                                                    ...
                                                    <%if session("EID") <>"" then%>
                                                        <a href="Influencer_THE_FUTURE_OF_WORK.asp"
                                                                            ...
                                                                            <%if session("EID") <>"" then%>
                                                                                ...
                                                                                <%else%>
                                                                                    ...
                                                                                    <%end if%>
                                                                                        ...
                                                                                        <a href="https://www.strategyr.com/market-report-future-of-work-forecasts-global-industry-analysts-inc.asp"
                                                                                            style="color:#fff!important; font-weight:600;"
                                                                                            class="rounded-0     btn_type_03 "
                                                                                            type="submit"
