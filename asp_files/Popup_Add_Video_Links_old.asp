...
.form-group input{
	...
	//alert(nsno);
	var addcolumndata = "<tr><td class='text-center'>"+nsno+"</td><td><input id='txtvDuration"+nsno+"' name='txtvDuration"+nsno+"'  type='text' placeholder='MM:SS' class='masked ml-1 border my-2 w-30' pattern='(1[0-2]|0[1-9]):(1[5-9]|2\d)' data-valid-example='01:30' /></td><td class='text-center'><textarea type='text' id='txtTranscription"+nsno+"' name='txtTranscription"+nsno+"' style='font-size:13px;' placeholder='Transcription' size='10' cols='50' rows='3' class='ml-1 border my-2 w-30'></textarea></td><td class='text-center'><select id='txtAllSpeakers"+nsno+"' name='txtAllSpeakers"+nsno+"' class='ml-1 border w-100 p-1' style='font-size:13px;'></select></td></tr>";
	//alert(markup);
	// $('#txtAllSpeakers'+nsno option').remove();
	 var myselect = $('<select>');
	var values = $.map($('#txtAllSpeakers option'), function(ele) 
	{	 
	...
	//$('#txtAllSpeakers'+nsno).append($("<option></option>").attr("value", ele.value ).text(ele.text));
	 ...
	 // $('#txtAllSpeakers'+nsno).append($("<option></option>").attr("value", ele.value).text(ele.text));
	  //alert(ele.value+'name= '+ele.text+ '#txtAllSpeakers'+nsno);
	   myselect.append( $('<option></option>').val(ele.value).html(ele.value) );
	});
	
	$('#txtAllSpeakers'+nsno).append(myselect.html());
												  ...
												  <div class="border m-0">
													<!--<span class="close ml-auto">&times;</span>-->
														...
														<div class="w-100">
														 <form>
															  		<div id="divajax"></div>
																   	<div class="row text-center mx-auto mb-3 p-2 alert alert-primary rounded-0">
																	<h4 class="w-100 font-weight-bold mb-0">ADD YOUTUBE VIDEO </h4>
																 	</div>	
																  
																  	<div class="w-100 mt-4">
																			
																			<!--div class="row  form-group mx-1 mt-3 d-flex w-100">
																				
																					<label for="staticEmail" class="col-sm-3 font-weight-bold col-form-label py-0 pr-0 ">Company:</label>
																					<div class="col-sm-9">
																					<input type="text" name="TxtCompanyName"  value="" id="TxtCompanyName" placeholder="Company Name" readonly class="ml-1 border w-100 p1">
																					  
																					</div>
																				 
																			 </div-->
																			  
																			<div class="form-group mx-1  d-flex w-100">
																				
																					<label for="staticEmail" class="col-sm-3 font-weight-bold col-form-label pt-2 pr-0">Youtube Link:</label>
																					<div class="col-sm-9">
																			...
																			<div class="form-group mx-1  d-flex w-100">
																					...
																					<label for="staticEmail" class="col-sm-3 font-weight-bold col-form-label pt-2 pr-0">Video Title:</label>
																					<div class="col-sm-9">
																			...
																			<div class="form-group mx-1  d-flex w-100">
																					...
																					<label for="staticEmail" class="col-sm-3 font-weight-bold col-form-label pt-2 pr-0">Video Date:</label>
																					<div class="col-sm-9">
																			...
																			<div class=" form-group mx-1  d-flex w-100">
																					...
																					<label for="staticEmail" class="col-sm-3 font-weight-bold col-form-label pt-2 pr-0">Video Duration:</label>
																					<div class="col-sm-9">
																			...
																			<div class="form-group mx-1  d-flex w-100">
																					...
																					<label for="staticEmail" class="col-sm-3 font-weight-bold col-form-label pt-2 pr-0">Description:</label>
																					<div class="col-sm-9">
																			 ...
																			 <!--div class="row  form-group mx-1  d-flex w-100">
																			 ...
																			 <!--div class="row form-group mx-1 mt-1 d-flex w-100">
																					...
																					<div class="col-sm-9">
																					  <textarea type="text" id="txtTranscription" name="txtTranscription" style="font-size:13px;" placeholder="Transcription" size="50" cols=70 rows=5 class="ml-1 border w-100 p-1"></textarea>
																					</div>
																			...
																			<div class="w-100 my-2 py-2  " style="background: #f7f7f7; font-size: 17px;color: #144084;">
																			...
																			<div class="row mx-0">
																				<div class=" form-group mt-1 col-6">																				  
																					<div class="col-12 d-flex ">
																					  <input type="checkbox" width="70px" id="txtecosystem" name="txtecosystem" placeholder="Ecosystem" data-toggle='collapse' data-target='#dvecosystem' class="mt-1"> <label for="staticEmail" class="  col-form-label py-0 ml-2 font-weight-bold">Ecosystem</label>
																				   </div>
																				   
																				   <div id="dvecosystem" class="col-12 collapse">
																					  <select id="txtEcocsystemname" name="txtEcocsystemname"  multiple class="p-2 mt-2 border w-100 d-none">
																			...
																			<div class="row mx-0">
																				<div class="form-group  mt-3 col-6 ">
																			 		<div class="col-12 d-flex ">
																				 	 	<input type="checkbox" width="70px" id="txtCompany" name="txtCompany" placeholder="Company" data-toggle='collapse' data-target='#dvCompany' class="mt-1"> 
																				  		<label for="staticEmail" class="ml-2  col-form-label py-0 font-weight-bold">Company</label>
																			   		</div>
																			   ...
																			   <div class="form-group  mt-3 col-6 ">
																					...
																					<div class="col-12">
																	  					<input type="checkbox" width="70px" id="txtSpeaker" name="txtSpeaker" placeholder="Speaker" data-toggle='collapse' data-target='#dvspeakers' class="mt-1">
																	  					<label for="staticEmail" class="ml-2  col-form-label py-0 font-weight-bold">Speakers</label>
																   					</div>
																   
																  				 < id="dvspeakers" name="dvspeakers" class="col-12 collapse mt-3"> 
																	 				 <div class="row" >
																						<div class="d-flex flex-column col-6">
																							<span class="w-100">
																							First Name: 
																							</span>
																							<input type="textbox" width="70px" id="txtfirstName" name="txtfirstName" placeholder="First Name">
																						</div>
																						<div class="d-flex flex-column col-6">
																							<span class="w-100">
																							Last Name: 
																					...
																					<div class="row" >
																	  						<div class="d-flex  flex-column col-6 mt-3">
																								<span class="col-12 pl-0">Gender: </span>
																								<span class="d-flex mt-2 col-12"> 
																									<span>
																							...
																							<div class="d-flex  flex-column col-6 mt-3">
																							 <input type="button" name="btnadd" onclick="AddSpeakers()" value="Add Speaker" class="mx-auto mt-3 mb-2 add-row">
																							</div>
																	...
																	<div class="w-100 my-2 py-2  " style="background: #f7f7f7; font-size: 17px;color: #144084;">
																	<label for="staticEmail" class="col-sm-3 font-weight-bold  col-form-label pl-2">Transcription:</label> 
																	</div>
																    <div class="row mx-0">
																	<div class="col-3">
																	 <label for="staticEmail" class="col-sm-3 font-weight-bold  col-form-label pl-2">Source</label><textarea type="text" id="txtTranscription" name="txtTranscription" style="font-size:13px;" placeholder="Full Source Transcription" size="10" cols="50" rows="3" class="ml-1 border my-2 w-35"></textarea>
																	</div>
																	 
																	 <div class="row form-group mx-1 mt-1 d-flex w-100">
																	 <table id="tblTranscription"cellpadding="0" cellspacing="0"  class="table table-bordered">
																	 <tbody><div>
																	 <tr><td colspan="4" class="p-2"><b>Transcription by time</b> &nbsp; <input type="button" onClick="return addcolumn();" value="ADD"> &nbsp; <input type="text" id="txtsno" value="1"></td></tr>
																	 <tr>
																	 <td valign="top">1</td>
																	 <td valign="top">
																	 <input id="txtvDuration1" name="txtvDuration1"  type="text" placeholder="MM:SS" class="masked ml-1 border my-2 w-30" pattern="(1[0-2]|0[1-9]):(1[5-9]|2\d)" data-valid-example="01:30" />
																	 </td>
																	 <td valign="top">
																	 <textarea type="text" id="txtTranscription1" name="txtTranscription1" style="font-size:13px;" placeholder="Transcription" size="10" cols="50" rows="3" class="ml-1 border my-2 w-30"></textarea>
																	 </td>
																	 <td valign="top">
																	 <select id="txtAllSpeakers1" name="txtAllSpeakers1" class="ml-1 border w-100 p-1" style="font-size:13px;">
																							<%Set Conn = Server.CreateObject("ADODB.Connection")
																							Set rsECO = Server.CreateObject("ADODB.Recordset")
																	 ...
																	 <div class="col-sm-12 py-3 text-center">
																		 <input type="button" class="mx-auto" id="btnSave" name="btnSave"   value=" ADD " onclick="addNEWVideo()">&nbsp;
																		 <input type="button" class="mx-auto" id="btnClose" name="btnClose" value="CLOSE" data-bs-dismiss="modal" onclick="Btnclose()">
																	  </div>
																   </div>
																</div>
																</div>																
														...
														<tbody>
															...
															<% while not RecChkRS.EOF %>															  
															   <tr>
																...
																<td width="24%"><%=RecChkRS("company")%></td>
																<td width="20%" class="p-1"><%=RecChkRS("First_Name")%></td>
																<td width="20%" class="p-1"><%=RecChkRS("Last_Name")%></td>
																<td width="20%" class="p-1"><%=RecChkRS("Designation")%></td>
																<td width="10%" class="text-center p-1"><%=RecChkRS("Gender")%></td>
															  </tr>	
