...
<link rel="stylesheet" href="css/clp_featrued_project_table.css" async/>
...
'''response.write(session.SessionID)			 
			 %>	
				...
				%>
                           ...
                           <table id="clp_featured_table" class="border-0">
                            <tr>
                                <td class="d-flex justify-content-between align-items-center w-100">
									<!--p class="font-weight-bold mb-0"> Did we miss a player? <a href="#addcompanies" rel="modal:open" class="ml-lg-3 ml-xl-3 ml-md-2 ml-sm-0 rounded-0  font-weight-bold  text-blue add_country" style="color:#169FE6 !important;font-size:14px !important">[ADD COMPANY]</a> </!p-->
...
var windowWidth = $(window).width(); 
 ...
 $("#clp_featured_table tr td:nth-child(1) h4").attr('class', 'text-limit'); 
 } 
  
 else{ 
 //Means screen is desktop or tablet 
 $("#clp_featured_table tr td:nth-child(1) h4").removeAttr('text-limit'); 
 } 
...
<script>
	...
	<script>
    $("#clp_featured_table  tr td input:radio").click(function() {
