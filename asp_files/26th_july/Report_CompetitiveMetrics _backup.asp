...
function NewComp_metrisAdd()
{

    var vtxtCmp_Name= $("#txtCmp_Name").val(); 	
	var vtxtRankCPNew = $("#txtRankCPNew").val();
	var vRtypeCPNew=  $('input[id=RtypeCPNew]:checked').val(); 	 
	...
	//  	
	  alert(vtxtCmp_Name);
		...
		//if (vtxtCmp_Name != null && vtxtCmp_Name != '' && vRtypeCPNew != null && vRtypeCPNew != ''  && vtxtRankCPNew != null && vtxtRankCPNew != '')
		 if (vtxtCmp_Name == null || vtxtCmp_Name == '')
		  {
		       alert('Company Name cannot be left blank');
				$("#txtCmp_Name").focus(); 
		  }
		  else if (vRtypeCPNew == null || vRtypeCPNew == '')
		  {
		       alert('Please select Rank');
				$("#vxtCmp_Name").focus(); 
		  }
		  else if (vtxtRankCPNew == null || vtxtRankCPNew == '')
		  {
		  ...
		  {  
			...
			$.ajax({
				...
				type: "POST",
				data:'vtxtCmp_Name='+encodeURIComponent(vtxtCmp_Name)+'&vRtypeCPNew='+encodeURIComponent(vRtypeCPNew)+'&vtxtRankCPNew='+encodeURIComponent(vtxtRankCPNew)+'', 				
...
'''response.write(session.SessionID)			 
			 %>	
                            ...
                            <tr class="m-0 p-0">
                                ...
                                <th>
                                    <div class="d-flex flex-column mb-0">
                                        <h4 class="text-center border-bottom mb-0"> RANK & SHARE</h4>
                                ...
                                <th>
                                    ...
                                    <h4 style="font-size:18px !important;font-weight:900 !important;"> % <span class="text-danger">*</span></h4>
                                </th>
                        ...
                        <!---TABLE BODY-->
                            ...
                            <!---ROW BEGIN (THIS ROW TO BE REPEATED) -->
                                    <tr class="<%=highlight%>">
                                            ...
                                            <td>
                                                    <input type="text" maxlength="4"  onchange="AddComp_metris('<%=RSInfluncer("filename")%>','<%=code%>')" name="Rank<%=RSInfluncer("filename")%>" id="Rank<%=RSInfluncer("filename")%>" value="<%=Rank%>" onkeypress='return isNumberKey(event,this)' maxlength='4' size='20' tabindex='3' class="textbox_border inputselector" placeholder="##.#" >
				...
				%>
				 ...
				 <div class="border-0 font-weight-bold" id="validate_msg" style="font-size: 13px !important;font-style: color:#000; font-weight:500; margin-top:2px !important">
                              <sapn class="text-danger">*</sapn> D = Dominant; S = Strong; N = Niche; T = Trivial (&lt; 1%)
                        </div>
				 <div class="border-0 font-weight-bold" id="validate_msg" style="font-size: 13px !important;font-style: italic; margin-top:2px !important" >
                                        <sapn class="text-danger">*</sapn> Validated participants will receive complimentary Cluster data by email
                                    </div>
...
<div id="addcompanies" class="modal">
            ...
            <table id="competitive_metrics_table" class="my-2">
                ...
                <tbody>
                    <tr class="">
                        ...
                        <td>
                            <div class="d-flex w-100 justify-content-center">
                                <span class="short_text"> <input type="radio" onchange="NewComp_metrisAdd()" name="RtypeCPNew" id="RtypeCPNew" value="Dominant" class="p-0 mr-1" /></span>
                                <span class="short_text"><input type="radio" onchange="NewComp_metrisAdd()" name="RtypeCPNew" id="RtypeCPNew" value="Strong" class="p-0 mr-1" /></span>
                                <span class="short_text"><input type="radio" onchange="NewComp_metrisAdd()" name="RtypeCPNew" id="RtypeCPNew" value="Niche" class="p-0 mr-1" /> </span>
                                <span class="short_text"><input type="radio"onchange="NewComp_metrisAdd()" name="RtypeCPNew" id="RtypeCPNew" value="Trivial" class="p-0 mr-1" /> </span>
                            </div>
                        </td>
                        <td>
                            <input
    ...
    <div class="row text-center mb-0">
        <button onclick="NewComp_metrisAdd()" class="btn btn-gia-primary btn-sm m-3 p-2 rounded-0 shadow" onclick="">UPDATE</button> 
    </div>
</div>
</body>
</html>