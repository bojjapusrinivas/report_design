			...
			%>
							  ...
							  %>
                                        ...
                                        <div id="social_icon" class="w-100" style="">
                                            <div class="d-flex flex-wrap justify-content-center mt-3" id="crowd_rank_box">
                                                <div class="w-100 text-center border-top border-bottom">
                                                    <h4 class="font-weight-bold  my-2" style="font-size: 20px!important;">SHARE THIS PROFILE</h4>
                                                </div>
                                                    ...
                                                    <thead class="font-weight-bold">
                                                        <tr class="m-0 p-0">
                                                            <th class="d-flex flex-wrap justify-content-between">
                                                                <h4 class="ml-1">Market Influencer </h4>
                                                                <h4>
					...
					inf_ProjectQuery="SELECT top 10  code,title,file_name,dop  from stat_globind.dbo.mcpnewtopic WHERE code in (select distinct trim(token) from dbo.String_Split('" & trim(RSInfpeople("mcpcodes")) &"',';'))"		
						...
						Set rsMetrics = Server.CreateObject("ADODB.Recordset")								
							SqlMetrics="select * from tbl_Market_Influence_Score where CP_code in ('"&RSInfpeople("filename")&"') and MCP_code='" & RSInfProjects("code") & "'  and infcode='" & trim(session("infcode")) & "'"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                        ...
                                                                        <div class="w-100 d-flex justify-content-between">
                                                                            <div class="w-100 d-flex justify-content-between">
                                                                                <div class="input_block d-flex">
                                                                                    <input type="checkbox" data-toggle="collapse" <%=chkval%> data-target="#collapse_
                                                                                    <%=trim(RSInfProjects("code"))%>" aria-expanded="true" aria-controls="collapseOne" class="mr-2">

                                                                                        <h4 class="font-weight-bold">
                                                                                            <a href="https://www.strategyr.com/<%=trim(RSInfProjects(" file_name "))%>?encid=<%= trim(session("infcode "))%>" target="new" class="text-dark">
                                                                                                <%=trim(RSInfProjects("title"))%>
                                                                                            </a>
                                                                                        </h4>
                                                                                </div>
                                                                    ...
                                                                    <div id="collapse_<%=trim(RSInfProjects(" code "))%>" aria-expanded="false" class="collapse <%=chkshow%>">
                                                                        <div class="d-flex justify-content-between" id="crowd_rank_box">
                                                                            <input type="hidden" class="single-slider col-2" onchange="myFunction('<%=trim(RSInfProjects(" code "))%>txtval',this.value,'<%=RSInfpeople("filename ")%>','<%=trim(RSInfProjects("code "))%>');" value="<%=Rank%>" id="<%=trim(RSInfProjects(" code
                                                                                "))%>Sval" name="<%=trim(RSInfProjects(" code "))%>Sval">
                                                                            <div class="na_block ">
                                                                                ...
                                                                                <div class="d-flex">
                                                                                    <input type="hidden" <%=checked( "NA",RanK_Type)%> name="Opt
                                                                                    <%=trim(RSInfProjects("code"))%> value="N/A" onchange="AddMarket_Influencer_Score('
                                                                                        <%=RSInfpeople("filename")%>','
                                                                                            <%=trim(RSInfProjects("code"))%>')" customatt="radio_option" id="Opt
                                                                                                <%=trim(RSInfProjects("code"))%>" class="na_radio ml-0">
								...
								<label class="switch">
									...
									<span class="slider round d-flex justify-content-between">
										...
										<i>PUBLIC</i>
                                                                        ...
                                                                        <a href="#" onclick="AddAllComp_metris()" class="submit-button my-2  float-right" type="button"> SUBMIT
                           </a>
                                                                    </div>
                                                            </td>
                                                            <%else%>
								...
								<label class="switch">
									...
									<span class="slider round d-flex justify-content-between">
										...
										<i>PUBLIC VIEW</i>
                                                                                ...
                                                                                <a href="https://www.strategyr.com/LoginRepeat.asp" onclick="AddAllComp_metris()" class="submit-button my-2  float-right" type="button"> SUBMIT
                           </a>
                                                                    </div>
                                                                </td>
                                                                <%end if
					%>
                                ...
                                <tr-->
                                                ...
                                                <div class="border-0 font-weight-bold table_note" id="Influencer_table">
                                                    ...
                                                    Validated responses are published. Profile owner has data display discretion.
                                                </div>
                                                <!---END: NOTE MESSAGE-->
                                            </div>
                                            <!---TABLE END-->
                                        ...
                                        <div class="w-100 text-center">
                                            <a href="https://www.strategyr.com/companyinsider.asp?code=<%=filemd5%>&cmpID=<%=cmpID%>&encID=<%=trim(session(" infcode "))%>" class="view_entire_pool_btn font-weight-bold" target="new">
                                                <%=companyname%>
                                            </a>
                                        </div>
                                        ...
                                        <div ID="COLLAPSE_BLOCK" class="mb-4">
                                            <!---BEGIN: BOTTOM THREE BUTTONS -->
                                            <div class="w-100 mt-3">
                                                <span class="d-flex flex-md-row flex-sm-row  justify-content-center flex-lg-nowrap flex-xl-nowrap flex-md-nowrap flex-sm-wrap" id="company_page_btn">
                        ...
                        aria-controls="collapseOne" type="button">
                     	VIEW PROFILE
								 ...
								 <input type="submit" id="submit_form" name="send_mail" value="SUBMIT FORM" class="button1 mx-auto rounded-0 shadow  d-block submit_button" style="float: none;">-->
                                        ...
                                        <div class="border-0 font-weight-bold table_note" id="Influencer_table">
                                            <span class="text-danger ">*</span>Claim your profile to assume total control of your profile. <br/>
                                            <span class="text-danger ">*</span>Enrich this profile if you’re a peer or know the influencer. <br/>
                                            <span class="text-danger ">*</span>Requires 2-factor authentication to participate.
                                        </div>
