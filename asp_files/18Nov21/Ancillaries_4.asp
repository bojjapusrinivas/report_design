...
================================================== -->
	...
	'response.end
		...
		RecChkSQL = "SELECT * FROM Ancillaries_1 WHERE (Code = '"&trim(giacode)&"' or Code = '"&trim(giacode1)&"') and eNcID ='"&trim(request("encID"))&"'"
                      ...
                      <div class="w-100 mt-0">
							...
							<div class=" show my-3" data-parent="#main">
								...
								<%
									  Set Conn = Server.CreateObject("ADODB.Connection")
												...
												RecChkSQL = "SELECT * FROM Ancillaries_Pricing_Trends WHERE (NewCode = '"&trim(request("code"))&"' or NewCode = '"&trim(giaid1)&"') and encID='"&trim(request("encID"))&"' and email_id='"&trim(session("EID"))&"'" 
								...
								<div class=" w-100 text-center mt-4"><h3 style=" color:#000; font-weight:700 ;letter-spacing: -1px; font-size:16px;">PRICING IMPACT<a herf="javascript:void(0)" class='text-primary' style="position: relative;">&nbsp;<i class="fa fa-info-circle info tooltippopup"  title="Overall effect on market value of the analyzed products/solutions/services"></i></a></h3></div>
                                    ...
                                    <div class="mr-3 w-xl-40 w-lg-40 w-md-70 w-sm- text-left mx-auto pricing_impact">
                                          <div  class=" w-100  d-flex justify-content-start  flex-wrap">
							...
							<div class="w-100  text-center  modules_page_title text-center mt-0"><h3 style=" color:#000; font-weight:700 ;letter-spacing: -1px; font-size:16px;"><!--YEAR OVER YEAR--> PRICING TRENDS<a herf="javascript:void(0)" class='text-primary'  style="position: relative;">&nbsp;<i class="fa fa-info-circle info tooltippopup"  title="YoY effect on total market value of the analyzed products/solutions/services"></i></a></h3></div>
                                <div class="row mx-0  mt-0 mb-2 px-lg-3 px-sm-0 px-md-2 px-xl-3">
                                    <!--div class="left_column">
										...
										<div class=" w-lg-80 w-xl-80 w-md-100 w-sm-95 text-center mt-2 mx-auto">
                        ...
                        <div class="  w-100  d-flex justify-content-start  flex-wrap">
                            ...
                            <div class="w-lg-50 w-xl-50 w-md-50 w-sm-100  mb-1 px-2 light_gray_responsive pt-1">
                                ...
                                <div class="w-100 d-flex justify-content-center justify-content-xs-start">
