                                ...
                                <div class="position-relitive">
                                    ...
                                    <div class="row">
                                        <div class="w-100 ">
                                            ...
                                            <span
                                                ...
                                                <%if session("EID") <>"" then%>
                                                    <a href="Influencer_CSR_EMPLOYEE_MATCHING.asp"
                                                        style="color:#fff!important; font-weight:600"
                                                        class="rounded-0    btn_type_03 " type="submit" name="btnsubmit"
                                                        value="OK">SURVEY</a>
                                                    <%else%>
                                                            ...
                                                            <%if session("EID") <>"" then%>
                                                                ...
                                                                <%else%>
                                                                    ...
                                                                    <%end if%>
                                                                        ...
                                                                        <%if session("EID") <>"" then%>
                                                                            <a href="https://www.strategyr.com/Survey_Influencers.asp?stype=Corporate social responsibility"
                                                                                style="color:#fff!important; font-weight:600"
                                                                            ...
                                                                            <%else%>
                                                                                ...
                                                                                <%end if%>
                                                                                    ...
                                                                                    <a href="https://www.strategyr.com/market-report-corporate-social-responsibility-CSR-employee-matching-forecasts-global-industry-analysts-inc.asp"
                                                                                        style="color:#fff!important; font-weight:600;"
                                                                                        class="rounded-0     btn_type_03 "
                                                                                        type="submit" name="btnsubmit"
                                                                                        value="OK">REPORT</a>
                                    ...
                                    <div class="row w-lg-85 w-xl-85 w-md-100 w-sm-100 w-100 mx-auto">
                                        ...
                                        <span class="text-danger">*</span> <a href="LoginRepeat.asp"
                                            class="font-weight-bold">Login</a> <span class="text-dark">to view what's
                                            trending, influencer insights and to participate in our ongoing
                                            survey.</span>
