                                ...
                                <div class="position-relitive">
                                    ...
                                    <div class="mt-2 w-100">
                                        ...
                                        <div class="row mb-2 w-lg-85 w-xl-85 w-md-100 w-sm-100 w-100 mx-auto">
                                            ...
                                            <p class="  mb-2">
                                                The priority for the post pandemic world is clear. It is digital transformation at speeds never before seen. Deemed as accelerators of innovation, enabler of transformation, driver of improved efficiency, new business models, products and services, and deliverer of better customer and employee experiences, digital technologies are the future of all businesses irrespective of scale and size. Every organization has its own indigenously developed, uniquely tailored set of strategies to navigate this very complex transformation. Surprisingly, our research shows that many business leaders have no clear understanding of what digital transformation really means. Does every digital transformation agenda needs to have a vision?  Howe many have implemented cultural changes as part of the initiative?  What does it take to integrate digital technology into all areas of a business? What challenges companies often face during the transformation process? How do they cope these challenges?  Your responses will help us find out.

                                            </p>
                                            <p class="  mb-2">GIA’s Executive Insights Campaign evokes creative solutions to complex problems and presents solutions through a dynamic virtual community of domain experts. The survey program is designed to build a roadmap for ongoing and future digital initiatives by identifying often encountered challenges, analyzing how they can be overcome, finding out what successful companies did right and what should be the best practices to implement to ensure success.        By capturing self-reported objectives, subjective data from experts including their experiences in the context of the digital transformation in their companies along with their relationships between the rise of emerging technologies, the survey is designed as a perspective builder into the myriad dimension of the very complex digital transformation journey. </p>
                                        ...
                                        <div class="row">
                                            <div class="w-100 ">
                                                ...
                                                <span
                                                    ...
                                                    <%if session("EID") <>"" then%>
                                                        <a href="https://www.strategyr.com/Influencer_DIGITAL_TRANSFORMATION.asp"
                                                                ...
                                                                <%if session("EID") <>"" then%>
                                                                    ...
                                                                    <%else%>
                                                                        ...
                                                                        <%end if%>
                                                                            ...
                                                                            <%if session("EID") <>"" then%>
                                                                                <a href="https://www.strategyr.com/Survey_Influencers.asp?stype=cryptocurrency"
                                                                                    style="color:#fff!important; font-weight:600"
                                                                                    class="rounded-0     btn_type_03 "
                                                                                    type="submit" name="btnsubmit"
                                                                                ...
                                                                                <%else%>
                                                                                    ...
                                                                                    <%end if%>
                                                                                        ...
                                                                                        <a href="https://www.strategyr.com/market-report-digital-transformation-forecasts-global-industry-analysts-inc.asp"
                                                                                            style="color:#fff!important; font-weight:600;"
                                                                                            class="rounded-0     btn_type_03 "
                                                                                            type="submit"
