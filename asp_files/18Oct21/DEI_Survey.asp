                                        ...
                                        <div class="row">
                                            <div class="w-100 ">
                                                ...
                                                <span
                                                    ...
                                                    <%if session("EID") <>"" then%>
                                                        <a href="DIVERSITY_INCLUSION_QUESTIONNAIRE.asp"
                                                                ...
                                                                <%if session("EID") <>"" then%>
                                                                    ...
                                                                    <%else%>
                                                                        ...
                                                                        <%end if%>
                                                                            ...
                                                                            <%if session("EID") <>"" then%>
                                                                                <a href="https://www.strategyr.com/Survey_Influencers.asp?stype=Diversity"
                                                                                    style="color:#fff!important; font-weight:600"
                                                                                    class="rounded-0     btn_type_03 "
                                                                                    type="submit" name="btnsubmit"
                                                                                ...
                                                                                <%else%>
                                                                                    ...
                                                                                    <%end if%>
                                                                                        ...
                                                                                        <a href="https://www.strategyr.com/market-report-diversity-and-inclusion-forecasts-global-industry-analysts-inc.asp"
                                                                                            style="color:#fff!important; font-weight:600;"
                                                                                            class="rounded-0     btn_type_03 "
                                                                                            type="submit"
