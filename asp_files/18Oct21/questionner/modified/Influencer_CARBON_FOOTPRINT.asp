                                        ...
                                        <div class="mt-2 w-100">
                                            ...
                                            <form id="questioner">
                                                ...
                                                <ul class="question mt-2 mb-3">
                                                    ...
                                                    <li>
                                                        <h4>What are the best practices you think are necessary to reduce your company’s carbon footprint and take the lead on climate policy?</h4>
                                                        <div class="ml">
                                                    ...
                                                    <li>
                                                        <h4>Why do you think companies continue to externalize climate change to other people, places and factors?</h4>
                                                    ...
                                                    <li>
                                                     ...
                                                     <!--26th Question-->
                                                     <li>
                                                        <h4>Do you believe “greenwashing” to be the biggest threat to sustainability goals? </h4>
                                                        <div class="ml">
                                                            <div class="d-flex  flex-wrap   justify-content-start">
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="radio" name="q26" id="q26_a">
                                                                    </div>
                                                                    <label>Yes </label>
                                                                </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="radio" name="q26" id="qq26_b">
                                                                    </div>
                                                                    <label>No </label>
                                                                </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="radio" name="q26" id="q26_c">
                                                                    </div>
                                                                    <label>Don’t Know </label>
                                                                </div>
                                                        ...
                                                        <div class="ml mt-2">
                                                            <div aria-expanded="false" class="collapse show">
                                                                <textarea class="form-control   comments_block" id="comment_q26"
                                                                    rows="2" placeholder="Comments"></textarea>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <!--27th Question-->
                                                    <li>
                                                        <h4>As a consumer have you been able to identify “greenwashing” in a company’s product or service? </h4>
                                                        <div class="ml">
                                                            <div class="d-flex  flex-wrap   justify-content-start">
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="radio" name="q27" id="q27_a">
                                                                    </div>
                                                                    <label>Yes </label>
                                                                </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="radio" name="q27" id="q27_b">
                                                                    </div>
                                                                    <label>No </label>
                                                                </div>
                                                                ...
                                                                <div class="mr-2 d-flex options">
                                                                    <div class="input_block">
                                                                        <input type="radio" name="q27" id="q27_c">
                                                                    </div>
                                                                    <label>Don’t Know </label>
                                                                </div>
                                                        ...
                                                        <div class="ml mt-2">
                                                            <div aria-expanded="false" class="collapse show">
                                                                <textarea class="form-control   comments_block" id="comment_q27"
                                                                    rows="2" placeholder="Comments"></textarea>
                                                            </div>
                                                        </div>
                                                      ...
                                                      <!---28th QUESTION-->
                                                      <li>
                                                        <h4>Several companies dedicate resources to popularize a brand’s green credentials without real commitment? Rank your approval or disapproval of the statement.</h4>
                                                        ...
                                                        <div class="ml mt-2">
                                                            <div aria-expanded="false" class="collapse show">
                                                                <textarea class="form-control   comments_block" id="comment_28"
                                                                    rows="2" placeholder="Comments"></textarea>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row text-center mb-2">
                                                <a href="javascript:void(0)"
                                                    ...
                                                    style="width:80px !important; color:#fff !important"
