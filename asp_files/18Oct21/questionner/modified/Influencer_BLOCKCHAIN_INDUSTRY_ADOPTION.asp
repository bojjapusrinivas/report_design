                       ...
                       <div class="collapse show my-3 w-100 p-0" id="questionnaire">
                        ...
                        <div class=" border position-relitive" id="questionnaire_block">
                            <div class="row text-primary  w-100 pb-2 mt-3 mb-0 text-center mt-0"
                                ...
                                <h1 class="font-weight-bold  line-height-normal" style="color: #E37038;"> BLOCKCHAIN </h1>
                            ...
                            <div class="mt-2 w-100">
                                ...
                                <form id="questioner">
                                    ...
                                    <ul class="question mt-2 mb-3">
                                            ...
                                            <div class="ml">
                                                <div class="d-flex flex-column justify-content-start toggle">
                                                    <div class="mr-2 d-flex  options ">
                                                        ...
                                                        <label>Implementing cryptocurrency based products </label>
                                                    </div>
                                                    ...
                                                    <div class="mr-2 d-flex options">
                                                        ...
                                                        <label>Implementing blockchain-enabled processes</label>
                                                    </div>
                                        ...
                                        <!---8nd QUESTION-->
                                        <li>
                                            <h4>Do you believe that blockchain-enabled processes can be a game changer?</h4>
                                            <div class="ml">
                                        ...
                                        <li>
                                            ...
                                            <div class="ml">
                                                ...
                                                <div class="d-flex flex-wrap justify-content-start ">
                                                    ...
                                                    <div class="mr-2 d-flex options">
                                                        <div class="input_block">
                                                            <input type="radio" name="q13" id="q13_g">
                                                        </div>
                                                        <label>Don’t Know, Not a Developer </label>
                                                    </div>
