                                    ...
                                    <div class="mt-2 w-100">
                                        ...
                                        <div class="row mb-2 w-lg-85 w-xl-85 w-md-100 w-sm-100 w-100 mx-auto">
                                            ...
                                            <ul class="forteen columns text-left gia_list_display mb-0 ml-3">
                                                <li>Self report your goals, objectives, experiences and share objective
                                                    information and subjective views and opinions in the context of
                                                    sustainability and carbon footprint management. Participating in the
                                                    survey will help you reflect on your experience to see patterns and
                                                    opportunities for learning you may have missed. </li>
                                                <li>Access our survey report and discover new curated insights shared by
                                                    ...
                                                    priorities.</li>
                                                <li>Find out what’s hard to achieve and why and how successful companies
                                                    on track to meet their carbon-emission-reduction targets got there.
                                                </li>
                                                <li>Be inspired to infuse new vigor into your carbon sequestration
                                                    strategies and get answers to questions you may confront along your
                                                    sustainability journey as an organization.</li>
                                                <li>View & track all influencers in this space.</li>
                                                <li>Read trending news, stories and updates. </li>
                                                <li>Access audio and video transcripts from hundreds of influencer
                                                    interviews, speeches, podcasts, open table conferences and more.
                                                </li>
                                            </ul>
                                        ...
                                        <div class="row">
                                            <div class="w-100 ">
                                                ...
                                                <span
                                                    ...
                                                    <%if session("EID") <>"" then%>
                                                        <a href="Influencer_CARBON_FOOTPRINT.asp"
                                                                ...
                                                                <%if session("EID") <>"" then%>
                                                                    ...
                                                                    <%else%>
                                                                        ...
                                                                        <%end if%>
                                                                            ...
                                                                            <%if session("EID") <>"" then%>
                                                                                <a href="https://www.strategyr.com/Survey_Influencers.asp?stype=<%=request("
                                                                                    stype")%>"
                                                                                    style="color:#fff!important;
                                                                                    font-weight:600" class="rounded-0
                                                                                    btn_type_03 " type="submit"
                                                                                ...
                                                                                <%else%>
                                                                                    ...
                                                                                    <%end if%>
                                                                                        ...
                                                                                        <a href="https://www.strategyr.com/market-report-carbon-footprint-forecasts-global-industry-analysts-inc.asp"
                                                                                            style="color:#fff!important; font-weight:600;"
                                                                                            class="rounded-0     btn_type_03 "
                                                                                            type="submit"
                                                                                            name="btnsubmit" value="OK"
