            ...
            <div class="col-7 p-2 right_block position-relative ">
                    ...
                    <div class="w-100 text-center mt-3 mb-2">
                        ...
                        <%  companies_list=split(RSeventMain("companynames"),";")
                            ...
                            next
                            %>
                            <li class="list_style"><i class="fa fa-check-square-o mr-1" aria-hidden="true"></i>View complete list at  <a href="www.StrategyR.com" style="color:#435FBD"> www.StrategyR.com</a></li>
                        </ul>
                        </div>
                    </div>
