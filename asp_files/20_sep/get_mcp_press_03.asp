...
<head>
    ...
    <link href="css/custom_style_template_03.css" rel="stylesheet">
   ...
   <!-- <div class="press_template_01 " id="press_template_01">-->
	<div id="wapper" class="p-0 mx-auto border">
        ...
        <div class="col-5 p-2  left_block position-relative">
            ...
            <div id="data_block">
                <div class="w-100 position-absolute data_image_block">
                     <img src="img/data_design_01.jpg" class="mx-auto d-block"/>
                </div>


                 <!--Begin-topstrip-->
                <div class="d-flex justify-content-center top_block">

                            <!--TABLES-->
                    <div class="tables d-flex flex-column justify-content-center  text-center">
                    
                        <h3 class="font_03 my-1 text-uppercase font-weight-bold ">TABLES</h3>
                        <h2 class=" "><%=RSeventMain("market_data_tables")%></h2>

                    </div>

                <!--PAGES-->
                
                <div class="pages d-flex flex-column justify-content-center  text-center">
                
                    <h3 class="font_03 my-1 text-uppercase font-weight-bold ">PAGES</h3>
                    <h2 class=" "> <%=RSeventMain("pages")%></h2>
             ...
             <!--endtopstrip-->
                ...
                <div class="d-flex justify-content-between bottom_block">
                            ...
                            <!--date-->
                    <div class="date d-flex flex-column justify-content-center  text-center">
                    
                        <h3 class="font_03 my-1 text-uppercase font-weight-bold ">DATE</h3>
                        <h2 class=" "><%=ucase(RSeventMain("smldop"))%></h2>

                    </div>

                <!--EDITION-->
                
                <div class="edition d-flex flex-column justify-content-center  text-center">
                
                    <h3 class="font_03 my-1 text-uppercase font-weight-bold ">EDITION</h3>
                    <h2 class=" "><%=RSeventMain("edition")%></h2>
             ...
             <!--endtopstrip-->
               ...
               <div class="w-100 position-absolute data_logo_block">
                     <img src="img/strategyr_logo_02.svg" class="mx-auto d-block logo_img"/>
                </div>
            ...
            <div class="w-100 text-center my-2">
                  ...
                  <img src="img/34.svg" class="logo_34 m-auto "/>
            ...
            <div class="executive_block">
                    <!--Executive Pool -->
            <div class=" d-flex flex-row justify-content-between py-2 px-3  ">
             
                 <h3 class="font_03 my-0 text-uppercase font-weight-bold ">COMPETITORS</h3>
                 <h2 class="right my-0 font_02 "><%=RSeventMain("companies")%></h2>
            ...
            <div class=" d-flex flex-row justify-content-between  py-2 px-3 ">
                 <h3 class="font_03 my-0 text-uppercase font-weight-bold ">EXECUTIVE POOL </h3>
                 <h2 class="text-right my-0 font_02 "><%=RSeventMain("pool_outreach")%></h2>
              ...
              <!--Competitors  -->
                ...
                <div class="   d-flex flex-row justify-content-between  py-2 px-3  ">
                    <h3 class="font_03 my-0 text-uppercase font-weight-bold ">PARTICIPANTS </h3>
                    <h2 class=" text-right my-0  font_02"><%=RSeventMain("Participants")%></h2>
                 </div>
    ...
    <div class="col-10 mx-auto">
        ...
        <div class="col-7 p-2 right_block position-relative">
                    ...
                    <div class="w-100">
                        <ul class="p-0 m-0 d-flex flex-wrap flex-row  geographics">
                           <% if trim(RSeventMain("region"))="GEO_A" then%>
                            ...
                            <li class="list_style" style="letter-spacing: -1px;"><i class="fa fa-check-square-o mr-1" aria-hidden="true"></i>South Korea</li>
                ...
                <!---- SEGMENTS SECTION----->
                <div class="w-100 text-center mt-3 mb-1">
                    <h2 class="text-center font_02">SEGMENTS - INDEPENDENTLY ANALYZED</h2>
                    <div class="w-100 d-flex mb-1 flex-column">
                      
                       <ul class="p-0 m-0 d-flex mb-2 flex-wrap flex-row segments">
				...
				While not RSSegments.EOF
						if (trim(stype)<> trim(RSSegments("type"))) then%>
							<%if segmentid <> 1 and segmentid>1 then%>
							 </ul>
							</div>
							<%end if%>
