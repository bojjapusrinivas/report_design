...
<script type="text/javascript">
    ...
    <link rel="stylesheet" href="deg_custom_styles4.css" />
...
//			url: "getSegData.asp",	
  ...
  function updatePercentageValue_MS(vSegmentID,OvSegType,vYear,vCountry,vSegSize,vSegPercent,vMtype,vOldSegSize,vOldSegPercent,YearTotVal) {
		...
		function GenerateCurveData()
		{
			...
			if (vGIANO != null && vGIANO != '' )		 
			{
				if (confirm("Do you want to generate curve logic data? NOTE: This will update/add new logic data") == true) 
				{
					alert ("curve logic activated");
				}
				else {
					alert ("curve logic cancelled");
				}
			}
			else
			{
		...
		function ViewCurveData()
		{
			var vGIANO = $("#txtGIA_NO").val();		
			//alert (vGIANO);		
			if (vGIANO != null && vGIANO != '' )		 
			{
				alert ("View curve logic data here");
				$.ajax({
							url: "getSegmentCurve_Logic.asp",
							type: "POST",
							data:'vGIANO='+vGIANO+'',
							success: function(data){
						    ...
						    // var vsegCount = res[1];		
						     //var vB2B = res[2];	
							 //SegPrimaryData
							$('#SegmentCurveData').empty().append(data);							
        ...
        <div class="navbar">
            <div id="wapper">
                ...
                <span>
					...
					<a href="http://205.234.30.74/degnumbers/GIA_DEG_Numbers_Multiplyers.asp" target="new"><i class="fa fa-users" aria-hidden="true"></i>
...
`                                                                                               
        ...
        <div class="w-100">
			...
			<form name="frmadd" method="post" >
                <table class="table border" id="baseline_data_table">
                    <tbody>
                        <tr>
                            ...
                            <td style="width: 55%"><b>
                                    <font color="red"><sup>*</sup></font>CURVE LOGIC LIBRARY
                                </b>:
                                <!--input name="txtCruve_ID" type="text" id="txtCruve_ID" onChange="GetCurveData(this);" placeholder=" Select Library" style="color: #000 !important; font-size: 15px; font-weight: 600;"-->
                                <select name="txtCruve_ID" id="txtCruve_ID" style="color: #000 !important; font-size: 15px; font-weight: 600;">
                                    <option value="">Select Library</option>                                    
                                    <option value="L1">Library 1 - Fast Growing</option>
                                    <option value="L2">Library 2 - Slow Growing</option>
									<option value="L3">Library 3 - Medium Growing</option>
                                    <option value="L4">Library 4 - Negative Growing</option>
                                    <option value="L5">Library 5 - S Curve Growth</option>
                                    <option value="L6">Library 6 - J Curve Growth</option>
                                    <option value="L7">Library 7 - Flat Growth</option>
                                    <option value="L8">Library 8 - Positive Growth</option>                                   
                                </select>
								</td><td style="width: 15%"><b>
                                    <font color="red" style="height:33px;"><sup>&nbsp;&nbsp;&nbsp;</sup></font>
                                </b>
								<input style="background-color: #2196F3;width:210px;height:33px;" type="button" name="btnCurveGenerate" class="mt-2 btn-primary p-2 shadow-sm border-0 mx-1 mb-3" value="GENERATE CURVE" onClick="GenerateCurveData();" id="btnCurveGenerate"> &nbsp; 
								&nbsp;&nbsp;<input style="background-color: #2196F3;width:210px;height:33px;" type="button" name="btnCurveView" class="mt-2 btn-primary p-2 shadow-sm border-0 mx-1 mb-3" value="VIEW CURVE" onClick="ViewCurveData();" id="btnCurveView"> &nbsp; 
				...
				<div class=" w-100 pl-2" id="SegmentCurveData"> 								
    ...
    $(document).ready(function () {
        $("#segment_allocation_primary table tr:nth-child(1) th:nth-child(5)").attr("colspan", "2")
        $("#segment_allication table tr:nth-child(1) th:nth-child(5)").attr("colspan", "2")
        $("#market-staging tr th:nth-child(4)").attr("colspan", "3")
